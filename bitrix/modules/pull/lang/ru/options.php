...
$MESS["PULL_OPTIONS_PATH_TO_JSON_RPC"] = "Путь для выполнение JSON-RPC запросов";
...
$MESS["PULL_OPTIONS_NGINX_VERSION_730_2"] = "Виртуальная машина 7.3 - 7.5 (Bitrix Push server 2.0)";
$MESS["PULL_OPTIONS_NGINX_VERSION_760"] = "Виртуальная машина 7.6 и новее (Bitrix Push server 3.0)";
...
$MESS["PULL_NOTIFY_DEPRECATED"] = "Версии сервера ниже 2.0 больше не поддерживаются. Используйте Bitrix Push server 2.0 и выше или подключите облачный сервер. <a href=\"https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=41&LESSON_ID=21636\" target=\"_blank\">Подробнее.</a>";
?>