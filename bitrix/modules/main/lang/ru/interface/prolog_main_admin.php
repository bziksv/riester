...
$MESS["prolog_main_support_wit_descr2_l"] = "Окончание срока действия стандартной лицензии приводит к наложению ограничений на систему обновлений, на некоторые функциональные возможности продукта и техническую поддержку.<br /><br />
 После окончания срока действия стандартной лицензии вы не сможете устанавливать обновления платформы, получать новые версии продукта и устанавливать дополнения из каталога решений Маркетплейс, а также продления для них. Одновременно с этим прекращается работа наших облачных сервисов, например «CDN» или «Облачный бекап».<br /><br />
Также, для вас становится не доступной техническая поддержка.<br /><br />
Для того чтобы продолжить пользоваться вышеперечисленными возможностями, необходимо приобрести продление.<br /><br />
Обращаем ваше внимание, что вы можете продолжать использование продукта на условиях ограниченной лицензии без ограничения по времени.<br /><br />
С подробностями можно ознакомиться в «<a href=\"http://www.1c-bitrix.ru/download/law/eula_bus.pdf\" target=\"_blank\">Лицензионном соглашении</a>»
";
