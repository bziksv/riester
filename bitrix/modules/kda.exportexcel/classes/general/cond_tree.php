...
class CKDAExportGlobalCondCtrl
{
			...
			if (!$boolValueError)
			{
				...
				switch ($arControl['FIELD_TYPE'])
				{
					...
					case 'datetime':
						...
						$boolValueError = CKDAExportGlobalCondCtrl::ConvertInt2DateTime($arOneCondition['value'], $strFormat, $intOffset);
						break;
					default:
						$boolValueError = true;
						break;
			...
			if (!$boolError)
			{
				...
				switch ($arControl['FIELD_TYPE'])
				{
					...
					case 'datetime':
						...
						$boolError = CKDAExportGlobalCondCtrl::ConvertDateTime2Int($arOneCondition['value'], $strFormat, $intOffset);
						break;
					default:
						$boolError = true;
						break;
					...
					else
					{
						...
						switch ($arOneAtom['ATOM']['FIELD_TYPE'])
						{
							...
							case 'datetime':
								...
								$boolAtomError = CKDAExportGlobalCondCtrl::ConvertInt2DateTime($arOneCondition[$strID], $strFormat, $intOffset);
								break;
							default:
								$boolAtomError = true;
						}
					...
					if (!$boolAtomError)
					{
						switch ($arOneAtom['ATOM']['FIELD_TYPE'])
						{
							...
							case 'datetime':
								...
								$boolAtomError = CKDAExportGlobalCondCtrl::ConvertDateTime2Int($arOneCondition[$strName], $strFormat, $intOffset);
								break;
							default:
								$boolAtomError = true;
						}
...
class CKDAExportGlobalCondCtrlComplex extends CKDAExportGlobalCondCtrl
{
	public static function GetControlDescr()
	{
		$strClassName = get_called_class();
...
class CKDAExportGlobalCondCtrlGroup extends CKDAExportGlobalCondCtrl
{
	public static function GetControlDescr()
	{
		$strClassName = get_called_class();
...
class CKDAExportCatalogCondCtrl extends CKDAExportGlobalCondCtrl
{
}

class CKDAExportCatalogCondCtrlComplex extends CKDAExportGlobalCondCtrlComplex
{
}

class CKDAExportCatalogCondCtrlGroup extends CKDAExportGlobalCondCtrlGroup
{
}

class CKDAExportCatalogCondCtrlIBlockFields extends CKDAExportCatalogCondCtrlComplex
{
	/**
	 * @return string|array
	 */
...
class CKDAExportCatalogCondCtrlIBlockProps extends CKDAExportCatalogCondCtrlComplex
{
	/**
	 * @param bool|string $strControlID
	 * @return bool|array
...
class CKDAExportGlobalCondTree
{
	...
	public function OnConditionControlBuildList()
	{
		if (!$this->boolError && !isset($this->arControlList))
		{
			...
			$arMethods = array(
				array('CKDAExportCatalogCondCtrlGroup', 'GetControlDescr'),
				array('CKDAExportCatalogCondCtrlIBlockFields', 'GetControlDescr'),
				array('CKDAExportCatalogCondCtrlIBlockProps', 'GetControlDescr')
			);
...
class CKDAExportCondTree extends CKDAExportGlobalCondTree
{
	public function __construct()
	{
