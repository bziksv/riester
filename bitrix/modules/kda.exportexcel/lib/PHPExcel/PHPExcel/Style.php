 ...
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Style extends KDAPHPExcel_Style_Supervisor implements KDAPHPExcel_IComparable
{
    /**
     * Font
     *
     ...
     * Alignment
     *
     * @var KDAPHPExcel_Style_Alignment
     */
     ...
     * Number Format
     *
     * @var KDAPHPExcel_Style_NumberFormat
     */
     ...
     * Conditional styles
     *
     * @var KDAPHPExcel_Style_Conditional[]
     */
     ...
     * Protection
     *
     * @var KDAPHPExcel_Style_Protection
     */
    ...
    /**
     * Create a new KDAPHPExcel_Style
     *
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        $this->_font              = new KDAPHPExcel_Style_Font($isSupervisor, $isConditional);
        $this->_fill              = new KDAPHPExcel_Style_Fill($isSupervisor, $isConditional);
        $this->_borders           = new KDAPHPExcel_Style_Borders($isSupervisor, $isConditional);
        $this->_alignment         = new KDAPHPExcel_Style_Alignment($isSupervisor, $isConditional);
        $this->_numberFormat      = new KDAPHPExcel_Style_NumberFormat($isSupervisor, $isConditional);
        $this->_protection        = new KDAPHPExcel_Style_Protection($isSupervisor, $isConditional);
     ...
     *
     * <code>
     * $objKDAPHPExcel->getActiveSheet()->getStyle('B2')->applyFromArray(
     *         array(
     *             'font'    => array(
     *                 'name'      => 'Arial',
     *                 'bold'      => true,
     *                 'italic'    => false,
     *                 'underline' => KDAPHPExcel_Style_Font::UNDERLINE_DOUBLE,
     *                 'strike'    => false,
     *                 'color'     => array(
     *                     'rgb' => '808080'
     *                 )
            ...
            if ($this->_isSupervisor) {
                ...
                if ($pAdvanced && isset($pStyles['borders'])) {
                    ...
                    for ($x = 1; $x <= $xMax; ++$x) {
                        ...
                        $colStart = ($x == 3) ?
                            KDAPHPExcel_Cell::stringFromColumnIndex($rangeEnd[0])
                                : KDAPHPExcel_Cell::stringFromColumnIndex($rangeStart[0] + $x - 1);

                        // end column index for region
                        $colEnd = ($x == 1) ?
                            KDAPHPExcel_Cell::stringFromColumnIndex($rangeStart[0])
                                : KDAPHPExcel_Cell::stringFromColumnIndex($rangeEnd[0] - $xMax + $x);
     ...
     * @return KDAPHPExcel_Style
     */
    public function setFont(KDAPHPExcel_Style_Font $font)
    {
        $this->_font = $font;
        return $this;
    }
     ...
     * Get Alignment
     *
     * @return KDAPHPExcel_Style_Alignment
     */
     ...
     *
     * @param KDAPHPExcel_Style_Conditional[] $pValue Array of condtional styles
     * @return KDAPHPExcel_Style
     */
