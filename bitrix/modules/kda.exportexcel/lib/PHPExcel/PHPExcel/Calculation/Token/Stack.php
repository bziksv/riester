...
/**
 * KDAPHPExcel_Calculation_Token_Stack
 *
 * @category	KDAPHPExcel_Calculation_Token_Stack
 * @package		KDAPHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Calculation_Token_Stack {
	...
	public function push($type, $value, $reference = NULL) {
		...
		if ($type == 'Function') {
			$localeFunction = KDAPHPExcel_Calculation::_localeFunc($value);
