...
/**
 * KDAPHPExcel_Worksheet_CellIterator
 *
 ...
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Worksheet_CellIterator implements Iterator
{
	/**
	 ...
	 *
	 * @param KDAPHPExcel_Worksheet 		$subject
	 * @param int						$rowIndex
	 */
	public function __construct(KDAPHPExcel_Worksheet $subject = null, $rowIndex = 1) {
    ...
    /**
     * Are there any more KDAPHPExcel_Cell instances available?
     *
     * @return boolean
     */
    public function valid() {
        ...
        // position.
        $columnCount = KDAPHPExcel_Cell::columnIndexFromString($this->_subject->getHighestColumn());
