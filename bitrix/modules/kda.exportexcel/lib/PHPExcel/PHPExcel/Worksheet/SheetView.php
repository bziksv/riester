...
/**
 * KDAPHPExcel_Worksheet_SheetView
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Worksheet_SheetView
{
    ...
    /**
     * Create a new KDAPHPExcel_Worksheet_SheetView
     */
	...
	public function setZoomScale($pValue = 100) {
		...
		if (($pValue >= 1) || is_null($pValue)) {
			...
			//throw new KDAPHPExcel_Exception("Scale must be greater than or equal to 1.");
		}
		return $this;
	}
	...
	public function setView($pValue = NULL) {
		...
		if (in_array($pValue, self::$_sheetViewTypes)) {
			...
			throw new KDAPHPExcel_Exception("Invalid sheetview layout type.");
		}
