...
/**
 * KDAPHPExcel_Worksheet_AutoFilter_Column_Rule
 *
 * @category	KDAPHPExcel
 * @package		KDAPHPExcel_Worksheet
 * @copyright	Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Worksheet_AutoFilter_Column_Rule
{
...
//	const AUTOFILTER_COLUMN_RULE_ALLDATESINQUARTER	= 'allDatesInQuarter';	//	<dynamicFilter type="Q2"/> for Quarter 2
	 ...
	 * Autofilter Column
	 *
	 * @var KDAPHPExcel_Worksheet_AutoFilter_Column
	 */
	...
	/**
	 * Create a new KDAPHPExcel_Worksheet_AutoFilter_Column_Rule
	 *
	 * @param KDAPHPExcel_Worksheet_AutoFilter_Column $pParent
	 */
	public function __construct(KDAPHPExcel_Worksheet_AutoFilter_Column $pParent = NULL)
	{
	...
	public function setRuleType($pRuleType = self::AUTOFILTER_RULETYPE_FILTER) {
		if (!in_array($pRuleType,self::$_ruleTypes)) {
			throw new KDAPHPExcel_Exception('Invalid rule type for column AutoFilter Rule.');
		}
	...
	public function setValue($pValue = '') {
		if (is_array($pValue)) {
			...
			if (count($pValue) == 0) {
				throw new KDAPHPExcel_Exception('Invalid rule value for column AutoFilter Rule.');
			}
	...
	public function setOperator($pOperator = self::AUTOFILTER_COLUMN_RULE_EQUAL) {
		...
		if ((!in_array($pOperator,self::$_operators)) &&
			...
			throw new KDAPHPExcel_Exception('Invalid operator for column AutoFilter Rule.');
		}
	 ...
	 *
	 * @param KDAPHPExcel_Worksheet_AutoFilter_Column
	 * @return KDAPHPExcel_Worksheet_AutoFilter_Column_Rule
	 */
	public function setParent(KDAPHPExcel_Worksheet_AutoFilter_Column $pParent = NULL) {
		$this->_parent = $pParent;
