...
/**
 * KDAPHPExcel_Worksheet_HeaderFooterDrawing
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Worksheet_HeaderFooterDrawing extends KDAPHPExcel_Worksheet_Drawing implements KDAPHPExcel_IComparable
{
	/**
	 * Path
	 *
    ...
    /**
     * Create a new KDAPHPExcel_Worksheet_HeaderFooterDrawing
     */
