...
/**
 * KDAPHPExcel_Shared_XMLWriter
 *
 * @category   KDAPHPExcel
 * @package	KDAPHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Shared_XMLWriter extends XMLWriter {
	...
	/**
	 * Create a new KDAPHPExcel_Shared_XMLWriter instance
	 *
	...
	public function __construct($pTemporaryStorage = self::STORAGE_MEMORY, $pTemporaryStorageFolder = NULL) {
		...
		if ($pTemporaryStorage == self::STORAGE_MEMORY) {
			...
			if ($pTemporaryStorageFolder === NULL)
				$pTemporaryStorageFolder = KDAPHPExcel_Shared_File::sys_get_temp_dir();
