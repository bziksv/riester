...
/**
 * KDAPHPExcel_Shared_Escher_DggContainer
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Shared_Escher_DggContainer
{
	/**
	 ...
	 *
	 * @return KDAPHPExcel_Shared_Escher_DggContainer_BstoreContainer
	 */
	 ...
	 *
	 * @param KDAPHPExcel_Shared_Escher_DggContainer_BstoreContainer $bstoreContainer
	 */
