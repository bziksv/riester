...
/**
 * KDAPHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
{
	/**
	 ...
	 *
	 * @return KDAPHPExcel_Shared_Escher_DgContainer_SpgrContainer
	 */
	...
	public function getNestingLevel()
	{
		...
		while ($parent instanceof KDAPHPExcel_Shared_Escher_DgContainer_SpgrContainer) {
			++$nestingLevel;
