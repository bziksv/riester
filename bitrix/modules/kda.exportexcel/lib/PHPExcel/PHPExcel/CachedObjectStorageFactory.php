...
/**
 * KDAPHPExcel_CachedObjectStorageFactory
 *
 * @category    KDAPHPExcel
 * @package        KDAPHPExcel_CachedObjectStorage
 * @copyright    Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_CachedObjectStorageFactory
{
     ...
     *
     * @return KDAPHPExcel_CachedObjectStorage_ICache|NULL
     **/
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = 'KDAPHPExcel_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = 'KDAPHPExcel_CachedObjectStorage_'.$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = 'KDAPHPExcel_CachedObjectStorage_' . $method;
     ...
     *
     * @param    KDAPHPExcel_Worksheet     $parent        Enable cell caching for this worksheet
     * @return    KDAPHPExcel_CachedObjectStorage_ICache
     **/
    public static function getInstance(KDAPHPExcel_Worksheet $parent)
    {
