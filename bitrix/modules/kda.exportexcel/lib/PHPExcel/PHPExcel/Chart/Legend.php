...
/**
 * KDAPHPExcel_Chart_Legend
 *
 * @category	KDAPHPExcel
 * @package		KDAPHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Chart_Legend
{
	/** Legend positions */
	...
	/**
	 *	Create a new KDAPHPExcel_Chart_Legend
	 */
	public function __construct($position = self::POSITION_RIGHT, KDAPHPExcel_Chart_Layout $layout = NULL, $overlay = FALSE)
	{
