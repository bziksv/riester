...
/**
 * KDAPHPExcel_Style_Font
 *
 * @category   KDAPHPExcel
 * @package	KDAPHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Style_Font extends KDAPHPExcel_Style_Supervisor implements KDAPHPExcel_IComparable
{
	/* Underline types */
	...
	/**
	 * Create a new KDAPHPExcel_Style_Font
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		if ($isConditional) {
			...
			$this->_color			= new KDAPHPExcel_Style_Color(KDAPHPExcel_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
		} else {
	 ...
	 *
	 * <code>
	 * $objKDAPHPExcel->getActiveSheet()->getStyle('B2')->getFont()->applyFromArray(
	 *		array(
	 *			'name'		=> 'Arial',
	 *			'bold'		=> TRUE,
	 *			'italic'	=> FALSE,
	 ...
	 * Set Underline
	 *
	 * @param string|boolean $pValue	KDAPHPExcel_Style_Font underline type
