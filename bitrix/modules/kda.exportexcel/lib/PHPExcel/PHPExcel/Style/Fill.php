...
/**
 * KDAPHPExcel_Style_Fill
 *
 * @category   KDAPHPExcel
 * @package	KDAPHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Style_Fill extends KDAPHPExcel_Style_Supervisor implements KDAPHPExcel_IComparable
{
	/* Fill types */
	 ...
	 * @var string
	 */
	protected $_fillType	= KDAPHPExcel_Style_Fill::FILL_NONE;
	...
	/**
	 * Create a new KDAPHPExcel_Style_Fill
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		$this->_startColor			= new KDAPHPExcel_Style_Color(KDAPHPExcel_Style_Color::COLOR_WHITE, $isSupervisor, $isConditional);
		$this->_endColor			= new KDAPHPExcel_Style_Color(KDAPHPExcel_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
	 ...
	 *
	 * <code>
	 * $objKDAPHPExcel->getActiveSheet()->getStyle('B2')->getFill()->applyFromArray(
	 *		array(
	 *			'type'	   => KDAPHPExcel_Style_Fill::FILL_GRADIENT_LINEAR,
	 *			'rotation'   => 0,
	 *			'startcolor' => array(
	 *				'rgb' => '000000'
	 *			),
	 ...
	 * Set Fill Type
	 *
	 * @param string $pValue	KDAPHPExcel_Style_Fill fill type
	 * @return KDAPHPExcel_Style_Fill
	 */
	public function setFillType($pValue = KDAPHPExcel_Style_Fill::FILL_NONE) {
		if ($this->_isSupervisor) {
	 ...
	 * @return KDAPHPExcel_Style_Fill
	 */
	public function setStartColor(KDAPHPExcel_Style_Color $pValue = null) {
	 ...
	 * @return KDAPHPExcel_Style_Fill
	 */
	public function setEndColor(KDAPHPExcel_Style_Color $pValue = null) {
		// make sure parameter is a real color and not a supervisor
		$color = $pValue->getIsSupervisor() ? $pValue->getSharedComponent() : $pValue;
