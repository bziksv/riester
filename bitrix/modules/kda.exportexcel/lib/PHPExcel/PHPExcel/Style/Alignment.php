...
/**
 * KDAPHPExcel_Style_Alignment
 *
 * @category   KDAPHPExcel
 * @package	KDAPHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Style_Alignment extends KDAPHPExcel_Style_Supervisor implements KDAPHPExcel_IComparable
{
	 ...
	 * @var string
	 */
	protected $_horizontal	= KDAPHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
	 ...
	 * @var string
	 */
	protected $_vertical		= KDAPHPExcel_Style_Alignment::VERTICAL_BOTTOM;
	...
	/**
	 * Create a new KDAPHPExcel_Style_Alignment
	 *
	 ...
	 *
	 * <code>
	 * $objKDAPHPExcel->getActiveSheet()->getStyle('B2')->getAlignment()->applyFromArray(
	 *		array(
	 *			'horizontal' => KDAPHPExcel_Style_Alignment::HORIZONTAL_CENTER,
	 *			'vertical'   => KDAPHPExcel_Style_Alignment::VERTICAL_CENTER,
	 *			'rotation'   => 0,
	 *			'wrap'			=> TRUE
	 *		)
	 * );
	 ...
	 * @return KDAPHPExcel_Style_Alignment
	 */
	public function setHorizontal($pValue = KDAPHPExcel_Style_Alignment::HORIZONTAL_GENERAL) {
		if ($pValue == '') {
			$pValue = KDAPHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
		}
	 ...
	 * @return KDAPHPExcel_Style_Alignment
	 */
	public function setVertical($pValue = KDAPHPExcel_Style_Alignment::VERTICAL_BOTTOM) {
		if ($pValue == '') {
			$pValue = KDAPHPExcel_Style_Alignment::VERTICAL_BOTTOM;
		}
	...
	public function setTextRotation($pValue = 0) {
		// Excel2007 value 255 => KDAPHPExcel value -165
		if ($pValue == 255) {
			$pValue = -165;
		}
		...
		if ( ($pValue >= -90 && $pValue <= 90) || $pValue == -165 ) {
			...
			throw new KDAPHPExcel_Exception("Text rotation should be a value between -90 and 90.");
		}
