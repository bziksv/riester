...
/**
 * KDAPHPExcel_Style_Border
 *
 * @category   KDAPHPExcel
 * @package	KDAPHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Style_Border extends KDAPHPExcel_Style_Supervisor implements KDAPHPExcel_IComparable
{
	/* Border style */
	 ...
	 * @var string
	 */
	protected $_borderStyle	= KDAPHPExcel_Style_Border::BORDER_NONE;
	...
	/**
	 * Create a new KDAPHPExcel_Style_Border
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		// Initialise values
		$this->_color	= new KDAPHPExcel_Style_Color(KDAPHPExcel_Style_Color::COLOR_BLACK, $isSupervisor);
	 ...
	 *
	 * @param KDAPHPExcel_Style_Borders $parent
	...
	public function getSharedComponent()
	{
		switch ($this->_parentPropertyName) {
			...
			case '_outline':
			case '_vertical':
				throw new KDAPHPExcel_Exception('Cannot get shared component for a pseudo-border.');
				break;
			case '_bottom':
	 ...
	 *
	 * <code>
	 * $objKDAPHPExcel->getActiveSheet()->getStyle('B2')->getBorders()->getTop()->applyFromArray(
	 *		array(
	 ...
	 *							When passing a boolean, FALSE equates KDAPHPExcel_Style_Border::BORDER_NONE
	 *								and TRUE to KDAPHPExcel_Style_Border::BORDER_MEDIUM
	 * @return KDAPHPExcel_Style_Border
	 */
	public function setBorderStyle($pValue = KDAPHPExcel_Style_Border::BORDER_NONE) {

		if (empty($pValue)) {
			$pValue = KDAPHPExcel_Style_Border::BORDER_NONE;
		} elseif(is_bool($pValue) && $pValue) {
			$pValue = KDAPHPExcel_Style_Border::BORDER_MEDIUM;
		}
		if ($this->_isSupervisor) {
	 ...
	 * Set Border Color
	 *
	 * @param	KDAPHPExcel_Style_Color $pValue
	 * @throws	KDAPHPExcel_Exception
	 * @return KDAPHPExcel_Style_Border
	 */
	public function setColor(KDAPHPExcel_Style_Color $pValue = null) {
