...
/**
 * KDAPHPExcel_Writer_Excel5_Xf
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Writer_Excel5_Xf
{
    /**
	...
	*/
	 ...
	 *
	 * @access public
	 * @param KDAPHPExcel_Style	The XF format
	 */
	public function __construct(KDAPHPExcel_Style $style = null)
	{
	...
	function writeXf()
	{
		...
		$diag_tl_to_rb = $diagonalDirection == KDAPHPExcel_Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == KDAPHPExcel_Style_Borders::DIAGONAL_DOWN;
		$diag_tr_to_lb = $diagonalDirection == KDAPHPExcel_Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == KDAPHPExcel_Style_Borders::DIAGONAL_UP;
	 ...
	 *
	 */
	private static $_mapBorderStyle = array	( KDAPHPExcel_Style_Border::BORDER_NONE				=> 0x00,
											  KDAPHPExcel_Style_Border::BORDER_THIN				=> 0x01,
											  KDAPHPExcel_Style_Border::BORDER_MEDIUM				=> 0x02,
											  KDAPHPExcel_Style_Border::BORDER_DASHED				=> 0x03,
											  KDAPHPExcel_Style_Border::BORDER_DOTTED				=> 0x04,
											  KDAPHPExcel_Style_Border::BORDER_THICK				=> 0x05,
											  KDAPHPExcel_Style_Border::BORDER_DOUBLE				=> 0x06,
											  KDAPHPExcel_Style_Border::BORDER_HAIR				=> 0x07,
											  KDAPHPExcel_Style_Border::BORDER_MEDIUMDASHED		=> 0x08,
											  KDAPHPExcel_Style_Border::BORDER_DASHDOT				=> 0x09,
											  KDAPHPExcel_Style_Border::BORDER_MEDIUMDASHDOT		=> 0x0A,
											  KDAPHPExcel_Style_Border::BORDER_DASHDOTDOT			=> 0x0B,
											  KDAPHPExcel_Style_Border::BORDER_MEDIUMDASHDOTDOT	=> 0x0C,
											  KDAPHPExcel_Style_Border::BORDER_SLANTDASHDOT		=> 0x0D,
											);
	 ...
	 *
	 */
	private static $_mapFillType = array( KDAPHPExcel_Style_Fill::FILL_NONE					=> 0x00,
										  KDAPHPExcel_Style_Fill::FILL_SOLID					=> 0x01,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_MEDIUMGRAY		=> 0x02,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_DARKGRAY		=> 0x03,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_LIGHTGRAY		=> 0x04,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_DARKHORIZONTAL	=> 0x05,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_DARKVERTICAL	=> 0x06,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_DARKDOWN		=> 0x07,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_DARKUP			=> 0x08,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_DARKGRID		=> 0x09,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_DARKTRELLIS		=> 0x0A,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_LIGHTHORIZONTAL	=> 0x0B,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_LIGHTVERTICAL	=> 0x0C,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_LIGHTDOWN		=> 0x0D,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_LIGHTUP			=> 0x0E,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_LIGHTGRID		=> 0x0F,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_LIGHTTRELLIS	=> 0x10,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_GRAY125			=> 0x11,
										  KDAPHPExcel_Style_Fill::FILL_PATTERN_GRAY0625		=> 0x12,
										  KDAPHPExcel_Style_Fill::FILL_GRADIENT_LINEAR			=> 0x00,	// does not exist in BIFF8
										  KDAPHPExcel_Style_Fill::FILL_GRADIENT_PATH			=> 0x00,	// does not exist in BIFF8
										);
	/**
	 * Map fill type
	 *
	 ...
	 *
	 */
	private static $_mapHAlign = array( KDAPHPExcel_Style_Alignment::HORIZONTAL_GENERAL			=> 0,
										KDAPHPExcel_Style_Alignment::HORIZONTAL_LEFT				=> 1,
										KDAPHPExcel_Style_Alignment::HORIZONTAL_CENTER				=> 2,
										KDAPHPExcel_Style_Alignment::HORIZONTAL_RIGHT				=> 3,
										KDAPHPExcel_Style_Alignment::HORIZONTAL_JUSTIFY			=> 5,
										KDAPHPExcel_Style_Alignment::HORIZONTAL_CENTER_CONTINUOUS	=> 6,
									  );
	/**
	 ...
	 *
	 */
	private static $_mapVAlign = array( KDAPHPExcel_Style_Alignment::VERTICAL_TOP		=> 0,
										KDAPHPExcel_Style_Alignment::VERTICAL_CENTER	=> 1,
										KDAPHPExcel_Style_Alignment::VERTICAL_BOTTOM	=> 2,
										KDAPHPExcel_Style_Alignment::VERTICAL_JUSTIFY	=> 3,
									  );
	/**
	...
	private static function _mapLocked($locked) {
		switch ($locked) {
			case KDAPHPExcel_Style_Protection::PROTECTION_INHERIT:		return 1;
			case KDAPHPExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case KDAPHPExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 1;
		}
	}
	...
	private static function _mapHidden($hidden) {
		switch ($hidden) {
			case KDAPHPExcel_Style_Protection::PROTECTION_INHERIT:		return 0;
			case KDAPHPExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case KDAPHPExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 0;
		}
