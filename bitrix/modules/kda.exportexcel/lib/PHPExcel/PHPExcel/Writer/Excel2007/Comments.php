...
/**
 * KDAPHPExcel_Writer_Excel2007_Comments
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Writer_Excel2007_Comments extends KDAPHPExcel_Writer_Excel2007_WriterPart
{
	/**
	 ...
	 */
	public function writeComments(KDAPHPExcel_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * @param 	KDAPHPExcel_Comment				$pComment			Comment
	 * @param	array							$pAuthors			Array of authors
	 * @throws 	KDAPHPExcel_Writer_Exception
	 */
	public function _writeComment(KDAPHPExcel_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', KDAPHPExcel_Comment $pComment = null, $pAuthors = null)
	{
		// comment
	 ...
	 * @throws 	KDAPHPExcel_Writer_Exception
	 */
	public function writeVMLComments(KDAPHPExcel_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
		if ($this->getParentWriter()->getUseDiskCaching()) {
	 ...
	 * @throws 	KDAPHPExcel_Writer_Exception
	 */
	public function _writeVMLComment(KDAPHPExcel_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', KDAPHPExcel_Comment $pComment = null)
	{
 		// Metadata
 		list($column, $row) = KDAPHPExcel_Cell::coordinateFromString($pCellReference);
 		$column = KDAPHPExcel_Cell::columnIndexFromString($column);
 		$id = 1024 + $column + $row;
 		$id = substr($id, 0, 4);
