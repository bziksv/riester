...
$MESS["DISCOUNT_COUPON_SAVE_ERROR_COUPON_BASKET_ROW_INACTIVE"] = "coupon for one order item has already been used";
$MESS["DISCOUNT_COUPON_SAVE_ERROR_COUPON_INACTIVE"] = "coupon is inactive";
$MESS["DISCOUNT_COUPON_SAVE_ERROR_COUPON_MAX_USE_LIMIT"] = "reusable coupon has exceeded the maximum number of uses";
$MESS["DISCOUNT_COUPON_SAVE_ERROR_COUPON_ONE_ORDER_INACTIVE"] = "single-use coupon has already been used";
$MESS["DISCOUNT_COUPON_SAVE_ERROR_COUPON_WRONG_ACTIVE_PERIOD"] = "the order date is outside of the coupon active period";
$MESS["DISCOUNT_COUPON_SAVE_ERROR_DISCOUNT_INACTIVE"] = "shopping cart rule is inactive";
$MESS["DISCOUNT_COUPON_SAVE_ERROR_DISCOUNT_WRONG_ACTIVE_PERIOD"] = "the order date is outside of the shopping cart rule active period";
$MESS["DISCOUNT_COUPON_SAVE_ERROR_WRONG_USER_COUPON"] = "this coupon is personal but doesn't belong to order owner";
