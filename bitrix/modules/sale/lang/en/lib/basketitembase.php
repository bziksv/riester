<?php
$MESS["SALE_BASKET_AVAILABLE_FOR_ADDING_QUANTITY_IS_LESS"] = "#QUANTITY# pcs of \"#PRODUCT_NAME#\" have already been added to the cart. You can add up to #ADD# more.";
$MESS["SALE_BASKET_AVAILABLE_FOR_ADDING_QUANTITY_IS_ZERO"] = "Maximum available quantity (#QUANTITY#) of \"#PRODUCT_NAME#\" has already been added to the cart.";
