...
";
$MESS["DISCOUNT_CATALOG_MIGRATOR_PAGE_REPEAT_HELLO_TEXT"] = "<p>Вы уже выполняли объединение скидок. Повторять этот процесс рекомендуется лишь при серьезной необходимости.</p>";
$MESS["DISCOUNT_CATALOG_MIGRATOR_CONFIRM_MESSAGE"] = "Объединение скидок уже выполнялось. Вы уверены, что хотите повторно выполнить процесс?";