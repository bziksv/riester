	...
	var FileIcon = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(FileIcon, [{
	    ...
	    value: function generate() {
	      ...
	      var path1 = _classPrivateMethodGet(this, _createSvgElement, _createSvgElement2).call(this, 'path', {
	        'fill-rule': "evenodd",
	        'clip-rule': 'evenodd',
	      ...
	      var path2 = _classPrivateMethodGet(this, _createSvgElement, _createSvgElement2).call(this, 'path', {
	        'fill-rule': "evenodd",
	        'clip-rule': 'evenodd',
	        'opacity': '0.3',
	      ...
	      if (this.fileType === FileType.ARCHIVE) {
	        ...
	        var _iconType2 = _classPrivateMethodGet(this, _createSvgElement, _createSvgElement2).call(this, 'path', {
	          'fill-rule': 'evenodd',
	          'clip-rule': 'evenodd',
	        ...
	        container.appendChild(_iconType2);
	      }
