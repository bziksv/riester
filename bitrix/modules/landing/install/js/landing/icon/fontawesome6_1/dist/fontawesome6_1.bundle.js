...
(function (exports,landing_loc) {
	...
	var FontAwesome6_1 = {
	  ...
	  categories: [{
	    ...
	    items: [{
	      ...
	      options: ['fat fa-square-poll-horizontal', 'fal fa-square-poll-horizontal', 'far fa-square-poll-horizontal', 'fas fa-square-poll-horizontal'],
	      ...
	      options: ['fat fa-square-poll-vertical', 'fal fa-square-poll-vertical', 'far fa-square-poll-vertical', 'fas fa-square-poll-vertical'],
	    ...
	    id: 'charts-diagrams',
	    name: landing_loc.Loc.getMessage('LANDING_ICONS_SECTION_CHARTS_DIAGRAMS'),
	    items: [{
	      className: 'far fa-bars-progress',
	      options: ['fat fa-bars-progress', 'fal fa-bars-progress', 'far fa-bars-progress', 'fas fa-bars-progress'],
	      defaultOption: 'far fa-bars-progress',
	      ...
	      options: ['fat fa-chart-mixed', 'fal fa-chart-mixed', 'far fa-chart-mixed', 'fas fa-chart-mixed'],
	...
	exports.FontAwesome6_1 = FontAwesome6_1;

}((this.BX.Landing.Icon = this.BX.Landing.Icon || {}),BX.Landing));
//# sourceMappingURL=fontawesome6_1.bundle.js.map
