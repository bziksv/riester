<section class="landing-block g-pt-30 g-pb-30">
	<div class="container">
		<div class="text-uppercase g-line-height-1_3 g-mb-20">
			<h2 class="landing-block-node-title landing-semantic-title-medium js-animation fadeIn h1 mb-0">
		...
		<div class="fade show active">
			...
			<div class="landing-block-card js-animation slideInUp g-brd-bottom g-brd-gray-light-v5 g-py-20">
				<h6
					class="landing-block-faq-visible landing-semantic-subtitle-medium g-cursor-pointer text-uppercase g-font-weight-700 g-mb-10 g-color g-color--hover"
					style="--color:hsla(0, 0%, 43%, 1); --color-hover:hsla(0, 0%, 0%, 1);">
					What is Sites & stores?
				</h6>
				<div class="landing-block-faq-hidden landing-semantic-text-medium">
					Website builder.<br>
