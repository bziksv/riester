...
$MESS["BX_CATALOG_HELPER_PRODUCTEDIT_SECTION_QUANTITY"] = "Количественный учёт";
...
$MESS["BX_CATALOG_HELPER_PRODUCTEDIT_FIELD_TITLE_QUANTITY_TRACE"] = "Включить количественный учёт:";
...
$MESS["BX_CATALOG_HELPER_PRODUCTEDIT_FIELD_HINT_QUANTITY_FOR_SET"] = "Доступное количество комплекта рассчитывается по наличию товаров, у которых включен количественный учёт и запрещена покупка при отсутствии товара либо, если таких в комплекте нет, по всем товарам, входящим в комплект";
...
$MESS["BX_CATALOG_HELPER_PRODUCTEDIT_FIELD_HINT_PURCHASING_PRICE"] = "Закупочная цена устанавливается через документы складского учёта";
...
$MESS["BX_CATALOG_HELPER_PRODUCTEDIT_MESS_QUANTITY_TRACE_SET"] = "Параметры \"Включить количественный учёт\", \"Разрешить покупку при отсутствии товара (включая разрешение отрицательного количества товара)\", выставляются автоматически, на основание значений товаров, которые входят в комплект и не могут быть изменены в ручную.<br>
Если хотя бы для одного товара, входящего в комплект, включен количественный учёт и запрещена покупка при отсутствии товара, у комплекта тоже будет включен количественный учёт.";
...
$MESS["BX_CATALOG_HELPER_PRODUCTEDIT_MESS_STORES_AMOUNT_INFO"] = "Складкой учёт выключен. Количество товара на складах носит информационный характер и не влияет на расчет остатков товара.";
