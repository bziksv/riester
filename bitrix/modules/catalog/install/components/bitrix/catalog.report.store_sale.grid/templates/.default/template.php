...
foreach ($arResult['GRID']['ROWS'] as &$row)
{
	...
	{
		$row['columns']['TITLE'] =
			'<a class="store-report-link" onclick="BX.Catalog.Report.StoreSale.StoreGrid.Instance.openStoreProductListGrid('
...
<script>
	...
	BX.ready(() => {
		BX.Catalog.Report.StoreSale.StoreGrid.Instance = new BX.Catalog.Report.StoreSale.StoreGrid({
