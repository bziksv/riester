<?php
$MESS['STORE_SALE_PRODUCTS_REPORT_GRID_PRODUCT_COLUMN'] = 'Товар';
...
$MESS['STORE_SALE_PRODUCTS_REPORT_GRID_AMOUNT_SOLD_COLUMN'] = 'Продано';
$MESS['STORE_SALE_PRODUCTS_REPORT_GRID_AMOUNT_SOLD_COLUMN_HINT'] = 'Общее количество продаж за период по проведенным документам реализации';
$MESS['STORE_SALE_PRODUCTS_REPORT_GRID_AMOUNT_COLUMN'] = 'Конечный остаток';
$MESS['STORE_SALE_PRODUCTS_REPORT_GRID_AMOUNT_COLUMN_HINT'] = 'Остаток товара на конец периода';
