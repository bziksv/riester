...
<head>
    ...
    <link rel="stylesheet" href="<?=SITE_TEMPLATE_PATH?>/css/jquery-ui/jquery-ui.css">
        ...
        <div class="header__top">
            <div class="header__head">
                ...
                <div class="header__info">
                    <div class="header__title"><? $APPLICATION->IncludeComponent("bitrix:main.include", "", ["AREA_FILE_SHOW" => "file", "PATH" => SITE_DIR."include/title.php"], false ); ?></div>
                    <div class="header__desc">Прямые поставки от производителей</div>
                </div>
            </div>
            <div class="header__contact">
                <div class="header__title">
                    <img src="<?=SITE_TEMPLATE_PATH?>/img/header_phone.jpg" alt="logo">
                    <span></span>
                </div>
