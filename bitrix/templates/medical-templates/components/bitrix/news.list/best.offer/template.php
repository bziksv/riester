		...
		<div class="goods__item_wrapper">
			...
			<div class="goods__info">
                ...
                <? if(count($arItem['ARTICLS']['VALUE']) > 1): ?>
                    <a href="javascript:void(0)" class="goods__basket icon-basket" onclick="$('.more_options').bPopup({ zIndex:1000, loadUrl: '/ajax/popup_option.php?ID=<?=$arItem['ID']?>' }).css({width: '100%'});"></a>
                <?else:?>
