...
?>
	...
	<form class="filter" method="get" action="">
		...
		<div class="filter__view">
			<a href="?<?=http_build_query(array_merge($GLOBALS['_GET'],array("TEMPLATE_THEME" => ".default")))?>" class="filter__view_link <?=($_SESSION['TEMPLATE_THEME'] == ".default") ? 'active' : ''?>">
			...
			<a href="?<?=http_build_query(array_merge($GLOBALS['_GET'],array("TEMPLATE_THEME" => "list")))?>" class="filter__view_link <?=($_SESSION['TEMPLATE_THEME'] == "list" OR !$_SESSION['TEMPLATE_THEME']) ? 'active' : ''?>">
