...
<div class="footer">
    ...
    <div class="container">
		...
		?>
		<div class="cookies-info"><noindex>Мы используем файлы <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['cookie']) ?>">cookies</a> для улучшения работы сайта, настройки рекламы и анализа посещаемости. Продолжая пользоваться сайтом, вы даёте <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['consent']) ?>">согласие на обработку персональных данных</a>, соглашаетеся с <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['personal_data']) ?>">политикой обработки персональных данных</a> и ознакомлены с <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['recommendation']) ?>">правилами применения рекомендательных технологий</a>. Для отказа от использования cookies отключите их сохранение в настройках браузера.</noindex></div>
    </div>
</div>
