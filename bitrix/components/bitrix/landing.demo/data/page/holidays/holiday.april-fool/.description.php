	...
	<div class="container">
		<div class="landing-block-node-bgimg g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_1--after g-px-20 g-py-200" style="background-image: url(\'https://cdn.bitrix24.site/bitrix/images/landing/business/1600x869/img1.jpg\');" data-fileid="-1">
			<div class="text-center g-pos-rel g-z-index-1 landing-block-node-container js-animation zoomIn">
				...
				<h2 class="landing-block-node-title d-inline-block g-brd-around g-brd-2 g-brd-white g-color-white g-font-weight-700 g-font-size-40 text-uppercase g-line-height-1_2 g-letter-spacing-5 g-py-12 g-px-20 g-mb-50">April Fools&amp;#039; Day</h2>
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0 g-flex-middle g-bg-black-opacity-0_5 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
							<article class="landing-block-node-img-title-border h-100 g-flex-middle text-center g-brd-around g-brd-white-opacity-0_2 text-uppercase g-color-white">
								<div class="g-flex-middle-item">
									<h3 class="landing-block-node-img-title g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20 g-mb-20">Surprise!</h3>
				...
				<div class="h-100 g-pb-0">
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover js-animation fadeIn">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0 g-flex-middle g-bg-black-opacity-0_5 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
							<article class="landing-block-node-img-title-border h-100 g-flex-middle text-center g-brd-around g-brd-white-opacity-0_2 text-uppercase g-color-white">
								<div class="g-flex-middle-item">
									<h3 class="landing-block-node-img-title g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20 g-mb-20">funny presents!</h3>
		...
		<div class="row landing-block-inner">
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h6 class="landing-block-node-card-title text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">red baloons</h6>
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h6 class="landing-block-node-card-title text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">purple baloons</h6>
						<div class="landing-block-node-card-text mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h6 class="landing-block-node-card-title text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">yellow baloons</h6>
						<div class="landing-block-node-card-text mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h6 class="landing-block-node-card-title text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">blue baloons</h6>
						<div class="landing-block-node-card-text mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h6 class="landing-block-node-card-title text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">Orange baloons</h6>
						<div class="landing-block-node-card-text mb-0">
			...
			<div class="landing-block-node-card col-lg-6 g-pl-100--md g-mb-30 js-animation slideInUp">
				<article class="landing-block-node-card-container media d-block d-md-flex h-100 g-bg-white">
					...
					<div class="media-body align-self-center g-py-50 g-pl-40 g-pl-0--md g-pr-40">
						<h6 class="landing-block-node-card-title text-uppercase g-letter-spacing-4 g-font-weight-700 g-mb-20">green baloons</h6>
						<div class="landing-block-node-card-text mb-0">
					...
					<div class="landing-block-node-img-container h-100 g-pos-rel g-parent u-block-hover">
						...
						<div class="landing-block-node-img-title-container w-100 g-pos-abs g-bottom-0 g-left-0 g-top-0 g-flex-middle g-bg-black-opacity-0_5 opacity-0 g-opacity-1--parent-hover g-pa-20 g-transition-0_2 g-transition--ease-in">
							<div class="h-100 g-flex-centered flex-column g-brd-white-opacity-0_2 text-uppercase">
								<h3 class="landing-block-node-img-title text-center g-color-white g-line-height-1_4 g-letter-spacing-5 g-font-size-20">surpise!</h3>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container js-animation text-center text-uppercase g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h6 class="landing-block-node-card-title g-color-white g-mt-minus-25 g-mb-10">party glasses</h6>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container js-animation text-center text-uppercase g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h6 class="landing-block-node-card-title g-color-white g-mt-minus-25 g-mb-10">Confetti</h6>
			...
			<div class="landing-block-node-card col-md-6 col-lg-4 g-mb-30 g-mb-0--md">
				...
				<article class="landing-block-node-card-container js-animation text-center text-uppercase g-theme-photography-bg-gray-dark-v2 g-color-white-opacity-0_5 fadeInRight">
					...
					<header class="g-letter-spacing-3 g-pos-rel g-px-40 g-mb-30">
						...
						<h6 class="landing-block-node-card-title g-color-white g-mt-minus-25 g-mb-10">greasepaint</h6>
						<div class="landing-block-node-card-text g-font-size-12 g-color-gray-dark-v4 mb-0"><p>FUSCE DOLOR LIBERO, EFFICITUR ET LOBORTIS AT, FAUCIBUS NEC NUNC.</p></div>
					</header>
