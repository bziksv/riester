	...
	'items' => [
		...
		'#block8608' => [
			...
			'style' => [
				...
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-mb-20',
					1 => 'landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-mb-20',
					2 => 'landing-block-node-title text-uppercase g-font-weight-700 g-font-size-18 g-mb-20',
				],
				'.landing-block-node-text' => [
					0 => 'landing-block-node-text',
					1 => 'landing-block-node-text',
					2 => 'landing-block-node-text',
				],
				'#wrapper' => [
