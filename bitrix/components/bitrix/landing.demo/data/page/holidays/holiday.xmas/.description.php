...
<style data-id="g-font-marmelad">.g-font-marmelad { font-family: "Marmelad", sans-serif; }</style>',
	...
	'items' => [
		...
		'#block10040' => [
			...
			'style' => [
				'.landing-block-node-block-bottom' => [
				...
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title g-font-weight-600 mb-0 g-text-transform-none g-font-marmelad g-font-size-26 g-font-weight-700 g-line-height-0_7',
				],
				'.landing-block-node-subtitle' => [
					0 => 'landing-block-node-subtitle g-font-weight-700 g-mb-25 g-font-marmelad font-weight-normal g-font-size-40 g-line-height-0_7',
				],
				'.landing-block-node-text' => [
		...
		'#block10041' => [
			...
			'style' => [
				...
				'.landing-block-node-element-title' => [
					0 => 'landing-block-node-element-title h5 g-mb-10 g-text-transform-none g-font-size-25 g-font-marmelad',
					1 => 'landing-block-node-element-title h5 g-mb-10 g-text-transform-none g-font-size-25 g-font-marmelad',
					2 => 'landing-block-node-element-title h5 g-mb-10 g-text-transform-none g-font-size-25 g-font-marmelad',
					3 => 'landing-block-node-element-title h5 g-mb-10 g-text-transform-none g-font-size-25 g-font-marmelad',
				],
				'.landing-block-node-element-text' => [
					0 => 'landing-block-node-element-text',
					1 => 'landing-block-node-element-text',
					2 => 'landing-block-node-element-text',
					3 => 'landing-block-node-element-text',
				],
		...
		'#block10043' => [
			...
			'nodes' => [
				...
				'.landing-block-node-icon' => [
					0 => ['classList' => ['landing-block-node-icon fa fa-snowflake-o']],
					1 => ['classList' => ['landing-block-node-icon fa fa-snowflake-o']],
					2 => ['classList' => ['landing-block-node-icon fa fa-snowflake-o']],
					3 => ['classList' => ['landing-block-node-icon fa fa-snowflake-o']],
					4 => ['classList' => ['landing-block-node-icon fa fa-snowflake-o']],
				],
				'.landing-block-node-text' => [
			...
			'style' => [
				'.landing-block-node-title' => [
					0 => 'landing-block-node-title u-heading-v7__title g-font-weight-600 g-mb-20 js-animation fadeInUp font-weight-normal g-font-marmelad g-font-size-65',
				],
				'.landing-block-node-text' => [
					0 => 'landing-block-node-text mb-0 js-animation fadeInUp',
				],
				'.landing-block-node-icon-element@0' => [
					0 => 'landing-block-node-icon-element g-color-primary d-inline g-font-size-8'
				],
				'.landing-block-node-icon-element@1' => [
					0 => 'landing-block-node-icon-element g-color-primary d-inline g-font-size-11'
				],
				'.landing-block-node-icon-element@2' => [
					0 => 'landing-block-node-icon-element g-color-primary d-inline g-font-size-14'
				],
				'.landing-block-node-icon-element@3' => [
					0 => 'landing-block-node-icon-element g-color-primary d-inline g-font-size-11'
				],
				'.landing-block-node-icon-element@4' => [
					0 => 'landing-block-node-icon-element g-color-primary d-inline g-font-size-8'
				],
				'#wrapper' => [
		...
		'#block10044' => [
			...
			'style' => [
				...
				'.landing-block-node-card-price-subtitle' => [
					0 => 'landing-block-node-card-price-subtitle',
					1 => 'landing-block-node-card-price-subtitle',
					2 => 'landing-block-node-card-price-subtitle',
				],
				'.landing-block-node-card-price' => [
				...
				'.landing-block-node-card-text' => [
					0 => 'landing-block-node-card-text g-mb-40',
					1 => 'landing-block-node-card-text g-mb-40',
		...
		'#block10048' => [
			...
			'style' => [
				...
				'.landing-block-node-card-text' => [
					0 => 'landing-block-node-card-text js-animation fadeInRightBig g-mb-40',
					1 => 'landing-block-node-card-text js-animation fadeInLeft g-mb-40',
				],
				'.landing-block-node-card-button' => [
