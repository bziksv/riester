...
$MESS["CT_BCS_CATALOG_COMPILATION_EMPTY_TEXT"] = "Fügen Sie die Produktelemente zur Auswahl hinzu und senden Sie den Link zur Auswahl an Ihren Kunden.";
$MESS["CT_BCS_CATALOG_COMPILATION_EMPTY_TITLE"] = "Diese Liste ist derzeit leer.";
$MESS["CT_BCS_CATALOG_COMPILATION_NOT_FOUND_TEXT"] = "Mit diesem Link kann keine Produktauswahl geöffnet werden. Stellen Sie bitte sicher, dass der Link korrekt ist, dann kontaktieren Sie bitte den Vertrieb.";
$MESS["CT_BCS_CATALOG_COMPILATION_NOT_FOUND_TITLE"] = "Produktauswahl wurde nicht gefunden";
