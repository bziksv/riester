...
$MESS["CT_BCS_CATALOG_COMPILATION_NOT_FOUND_TITLE"] = "Подборка не найдена";
$MESS["CT_BCS_CATALOG_COMPILATION_NOT_FOUND_TEXT"] = "Мы не можем найти подборку товаров по этой ссылке. Если вы сами ничего не меняли в ссылке, обратитесь к менеджеру, который ее прислал";
$MESS["CT_BCS_CATALOG_COMPILATION_EMPTY_TITLE"] = "Здесь пока нет товаров";
$MESS["CT_BCS_CATALOG_COMPILATION_EMPTY_TEXT"] = "Добавьте нужные товары в подборку, чтобы отправить ссылку клиенту";
