...
$isBaseLinkEnabled = $arCurrentValues['PAGER_BASE_LINK_ENABLE'] ?? 'N';
...
CIBlockParameters::AddPagerSettings(
	...
	true, //$bShowAllParam
	true, //$bBaseLink
	$isBaseLinkEnabled === 'Y' //$bBaseLinkEnabled
);
...
if ($catalogIncluded)
{
	if (!empty($filterDataValues))
	{
		$arComponentParameters['PARAMETERS']['CUSTOM_FILTER'] = array(
			...
			'TYPE' => 'CUSTOM',
			'JS_FILE' => CatalogCompilationComponent::getSettingsScript($componentPath, 'filter_conditions'),
