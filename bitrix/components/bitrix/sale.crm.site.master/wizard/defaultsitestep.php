...
class DefaultSiteStep extends \CWizardStep
{
	...
	public function initStep()
	{
		...
		$this->SetTitle(Loc::getMessage("SALE_CSM_WIZARD_DEFAULTSITESTEP_TITLE"));
	...
	public function showStep()
	{
		...
		<div class="ui-alert ui-alert-warning ui-alert-icon-warning">
			<span class="ui-alert-message"><?= Loc::getMessage("SALE_CSM_WIZARD_DEFAULTSITESTEP_INFO") ?></span>
		</div>
		<div class="adm-crm-site-master-paragraph">
			<?=Loc::getMessage("SALE_CSM_WIZARD_DEFAULTSITESTEP_SITE_LINK", [
				"#LANG#" => LANGUAGE_ID
			])?>
		</div>
		<?php
