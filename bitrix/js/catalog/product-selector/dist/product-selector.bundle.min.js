this.BX=this.BX||{};(function(e,t,i,s,o,r,n,a,l,c,d,h,g,u,I,E,m){"use strict";let p=e=>e,C,T,b,S,_,f,A,P;class L extends a.DefaultFooter{constructor(e,t){super(e,t);this.loader=null;this.errorAdminHint=t.errorAdminHint||"";this.getDialog().subscribe("onSearch",this.handleOnSearch.bind(this))}getContent(){let e="";const t=this.options.allowCreateItem===true||this.options.allowEditItem===false;if(this.isViewEditButton()&&t){e=g.Tag.render(C||(C=p`
		...
		`),e,t)}}class y{static getCodes(){return[y.NOT_SELECTED_PRODUCT,y.FAILED_PRODUCT]}}y.NOT_SELECTED_PRODUCT="NOT_SELECTED_PRODUCT";y.FAILED_PRODUCT="FAILED_PRODUCT";let R=e=>e,w,k,B,F,H,U,V,x,G,$,X,j,Q;class q{}q.SEARCHING="SEARCHING";q.SHOW_PRODUCT_ITEM="SHOW_PRODUCT_ITEM";q.SHOW_RECENT="SHOW_RECENT";var W=babelHelpers.classPrivateFieldLooseKey("showSelectedItem");var Y=babelHelpers.classPrivateFieldLooseKey("loadPreselectedItems");var K=babelHelpers.classPrivateFieldLooseKey("showPreselectedItems");var z=babelHelpers.classPrivateFieldLooseKey("searchItem");class J{constructor(e,t={}){Object.defineProperty(this,z,{value:ie});Object.defineProperty(this,K,{value:te});Object.defineProperty(this,Y,{value:ee});Object.defineProperty(this,W,{value:Z});this.cache=new g.Cache.MemoryCache;this.id=e||g.Text.getRandom();this.selector=t.selector;if(!(this.selector instanceof c.ProductSelector)){throw new Error("Product selector instance not found.")}this.model=t.model||{};this.isEnabledSearch=t.isSearchEnabled;this.isEnabledDetailLink=t.isEnabledDetailLink;this.inputName=t.inputName||c.ProductSelector.INPUT_FIELD_NAME;this.immutableFieldNames=[c.ProductSelector.INPUT_FIELD_BARCODE,c.ProductSelector.INPUT_FIELD_NAME];if(!this.immutableFieldNames.includes(this.inputName)){this.immutableFieldNames.push(this.inputName)}this.ajaxInProcess=false;this.loadedSelectedItem=null;this.handleSearchInput=g.Runtime.debounce(this.searchInDialog,500,this)}destroy(){}getId(){return this.id}getSelectorType(){return c.ProductSelector.INPUT_FIELD_NAME}getField(e){return this.model.getField(e)}getValue(){return this.getField(this.inputName)}getFilledValue(){return this.getNameInput().value||""}isSearchEnabled(){return this.isEnabledSearch}toggleIcon(e,t){if(g.Type.isDomNode(e)){g.Dom.style(e,"display",t)}}getNameBlock(){return this.cache.remember("nameBlock",(()=>g.Tag.render(w||(w=R`
				<div class="ui-ctl ui-ctl-textbox ui-ctl-w100">
					${0}
					${0}
					${0}
				</div>
			`),this.getNameTag(),this.getNameInput(),this.getHiddenNameInput())))}getNameTag(){if(!this.model.isNew()){return""}return g.Tag.render(k||(k=R`
			<div class="ui-ctl-tag">${0}</div>
		`),g.Loc.getMessage("CATALOG_SELECTOR_NEW_TAG_TITLE"))}getNameInput(){return this.cache.remember("nameInput",(()=>{const e=g.Tag.render(B||(B=R`
				<input type="text"
