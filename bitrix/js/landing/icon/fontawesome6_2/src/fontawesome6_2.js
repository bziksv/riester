...
export const FontAwesome6_2 = {
	...
	categories: [
		{
			id: 'construction',
			name: Loc.getMessage('LANDING_ICONS_SECTION_CONSTRUCTION'),
			items: [
				{
					className: 'far fa-angle',
					options: [
						'fat fa-angle', 'fal fa-angle', 'far fa-angle', 'fas fa-angle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-angle-90', 'fal fa-angle-90', 'far fa-angle-90', 'fas fa-angle-90',
					],
				...
				},
				{
					...
					options: [
						'fat fa-brush', 'fal fa-brush', 'far fa-brush', 'fas fa-brush',
					],
				...
				},
				{
					...
					options: [
						'fat fa-compass-drafting', 'fal fa-compass-drafting', 'far fa-compass-drafting', 'fas fa-compass-drafting',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dumpster', 'fal fa-dumpster', 'far fa-dumpster', 'fas fa-dumpster',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grate', 'fal fa-grate', 'far fa-grate', 'fas fa-grate',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grate-droplet', 'fal fa-grate-droplet', 'far fa-grate-droplet', 'fas fa-grate-droplet',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hammer', 'fal fa-hammer', 'far fa-hammer', 'fas fa-hammer',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hammer-crash', 'fal fa-hammer-crash', 'far fa-hammer-crash', 'fas fa-hammer-crash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-paint-roller', 'fal fa-paint-roller', 'far fa-paint-roller', 'fas fa-paint-roller',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pen-ruler', 'fal fa-pen-ruler', 'far fa-pen-ruler', 'fas fa-pen-ruler',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ruler', 'fal fa-ruler', 'far fa-ruler', 'fas fa-ruler',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ruler-combined', 'fal fa-ruler-combined', 'far fa-ruler-combined', 'fas fa-ruler-combined',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ruler-horizontal', 'fal fa-ruler-horizontal', 'far fa-ruler-horizontal', 'fas fa-ruler-horizontal',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ruler-triangle', 'fal fa-ruler-triangle', 'far fa-ruler-triangle', 'fas fa-ruler-triangle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ruler-vertical', 'fal fa-ruler-vertical', 'far fa-ruler-vertical', 'fas fa-ruler-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-screwdriver', 'fal fa-screwdriver', 'far fa-screwdriver', 'fas fa-screwdriver',
					],
				...
				},
				{
					...
					options: [
						'fat fa-screwdriver-wrench', 'fal fa-screwdriver-wrench', 'far fa-screwdriver-wrench', 'fas fa-screwdriver-wrench',
					],
				...
				},
				{
					...
					options: [
						'fat fa-shovel-snow', 'fal fa-shovel-snow', 'far fa-shovel-snow', 'fas fa-shovel-snow',
					],
				...
				},
				{
					...
					options: [
						'fat fa-toolbox', 'fal fa-toolbox', 'far fa-toolbox', 'fas fa-toolbox',
					],
				...
				},
				{
					...
					options: [
						'fat fa-triangle-person-digging', 'fal fa-triangle-person-digging', 'far fa-triangle-person-digging', 'fas fa-triangle-person-digging',
					],
		...
		{
			id: 'design',
			name: Loc.getMessage('LANDING_ICONS_SECTION_DESIGN'),
			items: [
				{
					className: 'far fa-angle',
					options: [
				...
				},
				{
					...
					options: [
						'fat fa-bezier-curve', 'fal fa-bezier-curve', 'far fa-bezier-curve', 'fas fa-bezier-curve',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bring-forward', 'fal fa-bring-forward', 'far fa-bring-forward', 'fas fa-bring-forward',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bring-front', 'fal fa-bring-front', 'far fa-bring-front', 'fas fa-bring-front',
					],
				...
				},
				{
					...
					options: [
						'fat fa-circle-dashed', 'fal fa-circle-dashed', 'far fa-circle-dashed', 'fas fa-circle-dashed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-crop', 'fal fa-crop', 'far fa-crop', 'fas fa-crop',
					],
				...
				},
				{
					...
					options: [
						'fat fa-crop-simple', 'fal fa-crop-simple', 'far fa-crop-simple', 'fas fa-crop-simple',
					],
				...
				},
				{
					...
					options: [
						'fat fa-distribute-spacing-horizontal', 'fal fa-distribute-spacing-horizontal', 'far fa-distribute-spacing-horizontal', 'fas fa-distribute-spacing-horizontal',
					],
				...
				},
				{
					...
					options: [
						'fat fa-distribute-spacing-vertical', 'fal fa-distribute-spacing-vertical', 'far fa-distribute-spacing-vertical', 'fas fa-distribute-spacing-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-droplet-slash', 'fal fa-droplet-slash', 'far fa-droplet-slash', 'fas fa-droplet-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-eye-dropper-full', 'fal fa-eye-dropper-full', 'far fa-eye-dropper-full', 'fas fa-eye-dropper-full',
					],
				...
				},
				{
					...
					options: [
						'fat fa-eye-dropper-half', 'fal fa-eye-dropper-half', 'far fa-eye-dropper-half', 'fas fa-eye-dropper-half',
					],
				...
				},
				{
					...
					options: [
						'fat fa-fill', 'fal fa-fill', 'far fa-fill', 'fas fa-fill',
					],
				...
				},
				{
					...
					options: [
						'fat fa-fill-drip', 'fal fa-fill-drip', 'far fa-fill-drip', 'fas fa-fill-drip',
					],
				...
				},
				{
					...
					options: [
						'fat fa-gallery-thumbnails', 'fal fa-gallery-thumbnails', 'far fa-gallery-thumbnails', 'fas fa-gallery-thumbnails',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grid', 'fal fa-grid', 'far fa-grid', 'fas fa-grid',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grid-2', 'fal fa-grid-2', 'far fa-grid-2', 'fas fa-grid-2',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grid-2-plus', 'fal fa-grid-2-plus', 'far fa-grid-2-plus', 'fas fa-grid-2-plus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grid-4', 'fal fa-grid-4', 'far fa-grid-4', 'fas fa-grid-4',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grid-5', 'fal fa-grid-5', 'far fa-grid-5', 'fas fa-grid-5',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grid-dividers', 'fal fa-grid-dividers', 'far fa-grid-dividers', 'fas fa-grid-dividers',
					],
				...
				},
				{
					...
					options: [
						'fat fa-lasso', 'fal fa-lasso', 'far fa-lasso', 'fas fa-lasso',
					],
				...
				},
				{
					...
					options: [
						'fat fa-lasso-sparkles', 'fal fa-lasso-sparkles', 'far fa-lasso-sparkles', 'fas fa-lasso-sparkles',
					],
				...
				},
				{
					...
					options: [
						'fat fa-object-group', 'fal fa-object-group', 'far fa-object-group', 'fas fa-object-group',
					],
				...
				},
				{
					...
					options: [
						'fat fa-object-ungroup', 'fal fa-object-ungroup', 'far fa-object-ungroup', 'fas fa-object-ungroup',
					],
				...
				},
				{
					...
					options: [
						'fat fa-objects-align-bottom', 'fal fa-objects-align-bottom', 'far fa-objects-align-bottom', 'fas fa-objects-align-bottom',
					],
				...
				},
				{
					...
					options: [
						'fat fa-objects-align-center-horizontal', 'fal fa-objects-align-center-horizontal', 'far fa-objects-align-center-horizontal', 'fas fa-objects-align-center-horizontal',
					],
				...
				},
				{
					...
					options: [
						'fat fa-objects-align-center-vertical', 'fal fa-objects-align-center-vertical', 'far fa-objects-align-center-vertical', 'fas fa-objects-align-center-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-objects-align-left', 'fal fa-objects-align-left', 'far fa-objects-align-left', 'fas fa-objects-align-left',
					],
				...
				},
				{
					...
					options: [
						'fat fa-objects-align-right', 'fal fa-objects-align-right', 'far fa-objects-align-right', 'fas fa-objects-align-right',
					],
				...
				},
				{
					...
					options: [
						'fat fa-objects-align-top', 'fal fa-objects-align-top', 'far fa-objects-align-top', 'fas fa-objects-align-top',
					],
				...
				},
				{
					...
					options: [
						'fat fa-objects-column', 'fal fa-objects-column', 'far fa-objects-column', 'fas fa-objects-column',
					],
				...
				},
				{
					...
					options: [
						'fat fa-paint-brush', 'fal fa-paint-brush', 'far fa-paint-brush', 'fas fa-paint-brush',
					],
				...
				},
				{
					...
					options: [
						'fat fa-paint-brush-fine', 'fal fa-paint-brush-fine', 'far fa-paint-brush-fine', 'fas fa-paint-brush-fine',
					],
				...
				},
				{
					...
					options: [
						'fat fa-paintbrush-pencil', 'fal fa-paintbrush-pencil', 'far fa-paintbrush-pencil', 'fas fa-paintbrush-pencil',
					],
				...
				},
				{
					...
					options: [
						'fat fa-rectangles-mixed', 'fal fa-rectangles-mixed', 'far fa-rectangles-mixed', 'fas fa-rectangles-mixed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-scribble', 'fal fa-scribble', 'far fa-scribble', 'fas fa-scribble',
					],
				...
				},
				{
					...
					options: [
						'fat fa-send-back', 'fal fa-send-back', 'far fa-send-back', 'fas fa-send-back',
					],
				...
				},
				{
					...
					options: [
						'fat fa-send-backward', 'fal fa-send-backward', 'far fa-send-backward', 'fas fa-send-backward',
					],
				...
				},
				{
					...
					options: [
						'fat fa-splotch', 'fal fa-splotch', 'far fa-splotch', 'fas fa-splotch',
					],
				...
				},
				{
					...
					options: [
						'fat fa-spray-can', 'fal fa-spray-can', 'far fa-spray-can', 'fas fa-spray-can',
					],
				...
				},
				{
					...
					options: [
						'fat fa-square-dashed', 'fal fa-square-dashed', 'far fa-square-dashed', 'fas fa-square-dashed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-swatchbook', 'fal fa-swatchbook', 'far fa-swatchbook', 'fas fa-swatchbook',
					],
				...
				},
				{
					...
					options: [
						'fat fa-vector-circle', 'fal fa-vector-circle', 'far fa-vector-circle', 'fas fa-vector-circle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-vector-polygon', 'fal fa-vector-polygon', 'far fa-vector-polygon', 'fas fa-vector-polygon',
					],
				...
				},
				{
					...
					options: [
						'fat fa-vector-square', 'fal fa-vector-square', 'far fa-vector-square', 'fas fa-vector-square',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wand-magic', 'fal fa-wand-magic', 'far fa-wand-magic', 'fas fa-wand-magic',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wand-magic-sparkles', 'fal fa-wand-magic-sparkles', 'far fa-wand-magic-sparkles', 'fas fa-wand-magic-sparkles',
					],
		...
		{
			id: 'devices-hardware',
			name: Loc.getMessage('LANDING_ICONS_SECTION_DEVICES_HARDWARE'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-camera-web-slash', 'fal fa-camera-web-slash', 'far fa-camera-web-slash', 'fas fa-camera-web-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-computer-mouse', 'fal fa-computer-mouse', 'far fa-computer-mouse', 'fas fa-computer-mouse',
					],
				...
				},
				{
					...
					options: [
						'fat fa-computer-mouse-scrollwheel', 'fal fa-computer-mouse-scrollwheel', 'far fa-computer-mouse-scrollwheel', 'fas fa-computer-mouse-scrollwheel',
					],
				...
				},
				{
					...
					options: [
						'fat fa-database', 'fal fa-database', 'far fa-database', 'fas fa-database',
					],
				...
				},
				{
					...
					options: [
						'fat fa-desktop', 'fal fa-desktop', 'far fa-desktop', 'fas fa-desktop',
					],
				...
				},
				{
					...
					options: [
						'fat fa-desktop-arrow-down', 'fal fa-desktop-arrow-down', 'far fa-desktop-arrow-down', 'fas fa-desktop-arrow-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-display', 'fal fa-display', 'far fa-display', 'fas fa-display',
					],
				...
				},
				{
					...
					options: [
						'fat fa-display-arrow-down', 'fal fa-display-arrow-down', 'far fa-display-arrow-down', 'fas fa-display-arrow-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-display-code', 'fal fa-display-code', 'far fa-display-code', 'fas fa-display-code',
					],
				...
				},
				{
					...
					options: [
						'fat fa-display-slash', 'fal fa-display-slash', 'far fa-display-slash', 'fas fa-display-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ethernet', 'fal fa-ethernet', 'far fa-ethernet', 'fas fa-ethernet',
					],
				...
				},
				{
					...
					options: [
						'fat fa-floppy-disk-pen', 'fal fa-floppy-disk-pen', 'far fa-floppy-disk-pen', 'fas fa-floppy-disk-pen',
					],
				...
				},
				{
					...
					options: [
						'fat fa-floppy-disks', 'fal fa-floppy-disks', 'far fa-floppy-disks', 'fas fa-floppy-disks',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hard-drive', 'fal fa-hard-drive', 'far fa-hard-drive', 'fas fa-hard-drive',
					],
				...
				},
				{
					...
					options: [
						'fat fa-keyboard-down', 'fal fa-keyboard-down', 'far fa-keyboard-down', 'fas fa-keyboard-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-keyboard-left', 'fal fa-keyboard-left', 'far fa-keyboard-left', 'fas fa-keyboard-left',
					],
				...
				},
				{
					...
					options: [
						'fat fa-laptop', 'fal fa-laptop', 'far fa-laptop', 'fas fa-laptop',
					],
				...
				},
				{
					...
					options: [
						'fat fa-laptop-arrow-down', 'fal fa-laptop-arrow-down', 'far fa-laptop-arrow-down', 'fas fa-laptop-arrow-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-laptop-slash', 'fal fa-laptop-slash', 'far fa-laptop-slash', 'fas fa-laptop-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-memory', 'fal fa-memory', 'far fa-memory', 'fas fa-memory',
					],
				...
				},
				{
					...
					options: [
						'fat fa-meter', 'fal fa-meter', 'far fa-meter', 'fas fa-meter',
					],
				...
				},
				{
					...
					options: [
						'fat fa-microchip-ai', 'fal fa-microchip-ai', 'far fa-microchip-ai', 'fas fa-microchip-ai',
					],
				...
				},
				{
					...
					options: [
						'fat fa-power-off', 'fal fa-power-off', 'far fa-power-off', 'fas fa-power-off',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sd-card', 'fal fa-sd-card', 'far fa-sd-card', 'fas fa-sd-card',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sd-cards', 'fal fa-sd-cards', 'far fa-sd-cards', 'fas fa-sd-cards',
					],
				...
				},
				{
					...
					options: [
						'fat fa-server', 'fal fa-server', 'far fa-server', 'fas fa-server',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sim-card', 'fal fa-sim-card', 'far fa-sim-card', 'fas fa-sim-card',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sim-cards', 'fal fa-sim-cards', 'far fa-sim-cards', 'fas fa-sim-cards',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tablet', 'fal fa-tablet', 'far fa-tablet', 'fas fa-tablet',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tablet-button', 'fal fa-tablet-button', 'far fa-tablet-button', 'fas fa-tablet-button',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tablet-screen', 'fal fa-tablet-screen', 'far fa-tablet-screen', 'fas fa-tablet-screen',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tablet-screen-button', 'fal fa-tablet-screen-button', 'far fa-tablet-screen-button', 'fas fa-tablet-screen-button',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tachograph-digital', 'fal fa-tachograph-digital', 'far fa-tachograph-digital', 'fas fa-tachograph-digital',
					],
		...
		{
			id: 'editing',
			name: Loc.getMessage('LANDING_ICONS_SECTION_EDITING'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-circle-ellipsis', 'fal fa-circle-ellipsis', 'far fa-circle-ellipsis', 'fas fa-circle-ellipsis',
					],
				...
				},
				{
					...
					options: [
						'fat fa-circle-ellipsis-vertical', 'fal fa-circle-ellipsis-vertical', 'far fa-circle-ellipsis-vertical', 'fas fa-circle-ellipsis-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-circle-trash', 'fal fa-circle-trash', 'far fa-circle-trash', 'fas fa-circle-trash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-delete-left', 'fal fa-delete-left', 'far fa-delete-left', 'fas fa-delete-left',
					],
				...
				},
				{
					...
					options: [
						'fat fa-delete-right', 'fal fa-delete-right', 'far fa-delete-right', 'fas fa-delete-right',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ellipsis', 'fal fa-ellipsis', 'far fa-ellipsis', 'fas fa-ellipsis',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ellipsis-stroke', 'fal fa-ellipsis-stroke', 'far fa-ellipsis-stroke', 'fas fa-ellipsis-stroke',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ellipsis-stroke-vertical', 'fal fa-ellipsis-stroke-vertical', 'far fa-ellipsis-stroke-vertical', 'fas fa-ellipsis-stroke-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ellipsis-vertical', 'fal fa-ellipsis-vertical', 'far fa-ellipsis-vertical', 'fas fa-ellipsis-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grid-horizontal', 'fal fa-grid-horizontal', 'far fa-grid-horizontal', 'fas fa-grid-horizontal',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grip', 'fal fa-grip', 'far fa-grip', 'fas fa-grip',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grip-dots', 'fal fa-grip-dots', 'far fa-grip-dots', 'fas fa-grip-dots',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grip-dots-vertical', 'fal fa-grip-dots-vertical', 'far fa-grip-dots-vertical', 'fas fa-grip-dots-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grip-lines', 'fal fa-grip-lines', 'far fa-grip-lines', 'fas fa-grip-lines',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grip-lines-vertical', 'fal fa-grip-lines-vertical', 'far fa-grip-lines-vertical', 'fas fa-grip-lines-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grip-vertical', 'fal fa-grip-vertical', 'far fa-grip-vertical', 'fas fa-grip-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hexagon-check', 'fal fa-hexagon-check', 'far fa-hexagon-check', 'fas fa-hexagon-check',
					],
				...
				},
				{
					...
					options: [
						'fat fa-link', 'fal fa-link', 'far fa-link', 'fas fa-link',
					],
				...
				},
				{
					...
					options: [
						'fat fa-link-simple', 'fal fa-link-simple', 'far fa-link-simple', 'fas fa-link-simple',
					],
				...
				},
				{
					...
					options: [
						'fat fa-link-simple-slash', 'fal fa-link-simple-slash', 'far fa-link-simple-slash', 'fas fa-link-simple-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-link-slash', 'fal fa-link-slash', 'far fa-link-slash', 'fas fa-link-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-octagon-check', 'fal fa-octagon-check', 'far fa-octagon-check', 'fas fa-octagon-check',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pen-paintbrush', 'fal fa-pen-paintbrush', 'far fa-pen-paintbrush', 'fas fa-pen-paintbrush',
					],
				...
				},
				{
					...
					options: [
						'fat fa-square-ellipsis', 'fal fa-square-ellipsis', 'far fa-square-ellipsis', 'fas fa-square-ellipsis',
					],
				...
				},
				{
					...
					options: [
						'fat fa-square-ellipsis-vertical', 'fal fa-square-ellipsis-vertical', 'far fa-square-ellipsis-vertical', 'fas fa-square-ellipsis-vertical',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash', 'fal fa-trash', 'far fa-trash', 'fas fa-trash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-arrow-up', 'fal fa-trash-arrow-up', 'far fa-trash-arrow-up', 'fas fa-trash-arrow-up',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can', 'fal fa-trash-can', 'far fa-trash-can', 'fas fa-trash-can',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can-arrow-up', 'fal fa-trash-can-arrow-up', 'far fa-trash-can-arrow-up', 'fas fa-trash-can-arrow-up',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can-check', 'fal fa-trash-can-check', 'far fa-trash-can-check', 'fas fa-trash-can-check',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can-list', 'fal fa-trash-can-list', 'far fa-trash-can-list', 'fas fa-trash-can-list',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can-plus', 'fal fa-trash-can-plus', 'far fa-trash-can-plus', 'fas fa-trash-can-plus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can-slash', 'fal fa-trash-can-slash', 'far fa-trash-can-slash', 'fas fa-trash-can-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can-undo', 'fal fa-trash-can-undo', 'far fa-trash-can-undo', 'fas fa-trash-can-undo',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-can-xmark', 'fal fa-trash-can-xmark', 'far fa-trash-can-xmark', 'fas fa-trash-can-xmark',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-check', 'fal fa-trash-check', 'far fa-trash-check', 'fas fa-trash-check',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-list', 'fal fa-trash-list', 'far fa-trash-list', 'fas fa-trash-list',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-plus', 'fal fa-trash-plus', 'far fa-trash-plus', 'fas fa-trash-plus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-slash', 'fal fa-trash-slash', 'far fa-trash-slash', 'fas fa-trash-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-undo', 'fal fa-trash-undo', 'far fa-trash-undo', 'fas fa-trash-undo',
					],
				...
				},
				{
					...
					options: [
						'fat fa-trash-xmark', 'fal fa-trash-xmark', 'far fa-trash-xmark', 'fas fa-trash-xmark',
					],
		...
		{
			id: 'education',
			name: Loc.getMessage('LANDING_ICONS_SECTION_EDUCATION'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-book-blank', 'fal fa-book-blank', 'far fa-book-blank', 'fas fa-book-blank',
					],
				...
				},
				{
					...
					options: [
						'fat fa-book-open', 'fal fa-book-open', 'far fa-book-open', 'fas fa-book-open',
					],
				...
				},
				{
					...
					options: [
						'fat fa-book-open-reader', 'fal fa-book-open-reader', 'far fa-book-open-reader', 'fas fa-book-open-reader',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bus-school', 'fal fa-bus-school', 'far fa-bus-school', 'fas fa-bus-school',
					],
				...
				},
				{
					...
					options: [
						'fat fa-diploma', 'fal fa-diploma', 'far fa-diploma', 'fas fa-diploma',
					],
				...
				},
				{
					...
					options: [
						'fat fa-glasses-round', 'fal fa-glasses-round', 'far fa-glasses-round', 'fas fa-glasses-round',
					],
				...
				},
				{
					...
					options: [
						'fat fa-globe-stand', 'fal fa-globe-stand', 'far fa-globe-stand', 'fas fa-globe-stand',
					],
				...
				},
				{
					...
					options: [
						'fat fa-masks-theater', 'fal fa-masks-theater', 'far fa-masks-theater', 'fas fa-masks-theater',
					],
		...
		{
			id: 'emoji',
			name: Loc.getMessage('LANDING_ICONS_SECTION_EMOJI'),
			items: [
				{
					className: 'far fa-face-angry',
					options: [
						'fat fa-face-angry', 'fal fa-face-angry', 'far fa-face-angry', 'fas fa-face-angry',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-angry-horns', 'fal fa-face-angry-horns', 'far fa-face-angry-horns', 'fas fa-face-angry-horns',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-anguished', 'fal fa-face-anguished', 'far fa-face-anguished', 'fas fa-face-anguished',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-anxious-sweat', 'fal fa-face-anxious-sweat', 'far fa-face-anxious-sweat', 'fas fa-face-anxious-sweat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-astonished', 'fal fa-face-astonished', 'far fa-face-astonished', 'fas fa-face-astonished',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-confounded', 'fal fa-face-confounded', 'far fa-face-confounded', 'fas fa-face-confounded',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-confused', 'fal fa-face-confused', 'far fa-face-confused', 'fas fa-face-confused',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-cowboy-hat', 'fal fa-face-cowboy-hat', 'far fa-face-cowboy-hat', 'fas fa-face-cowboy-hat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-disappointed', 'fal fa-face-disappointed', 'far fa-face-disappointed', 'fas fa-face-disappointed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-disguise', 'fal fa-face-disguise', 'far fa-face-disguise', 'fas fa-face-disguise',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-dizzy', 'fal fa-face-dizzy', 'far fa-face-dizzy', 'fas fa-face-dizzy',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-downcast-sweat', 'fal fa-face-downcast-sweat', 'far fa-face-downcast-sweat', 'fas fa-face-downcast-sweat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-drooling', 'fal fa-face-drooling', 'far fa-face-drooling', 'fas fa-face-drooling',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-explode', 'fal fa-face-explode', 'far fa-face-explode', 'fas fa-face-explode',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-expressionless', 'fal fa-face-expressionless', 'far fa-face-expressionless', 'fas fa-face-expressionless',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-eyes-xmarks', 'fal fa-face-eyes-xmarks', 'far fa-face-eyes-xmarks', 'fas fa-face-eyes-xmarks',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-fearful', 'fal fa-face-fearful', 'far fa-face-fearful', 'fas fa-face-fearful',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-flushed', 'fal fa-face-flushed', 'far fa-face-flushed', 'fas fa-face-flushed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-frown-open', 'fal fa-face-frown-open', 'far fa-face-frown-open', 'fas fa-face-frown-open',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-frown-slight', 'fal fa-face-frown-slight', 'far fa-face-frown-slight', 'fas fa-face-frown-slight',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-glasses', 'fal fa-face-glasses', 'far fa-face-glasses', 'fas fa-face-glasses',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grimace', 'fal fa-face-grimace', 'far fa-face-grimace', 'fas fa-face-grimace',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin', 'fal fa-face-grin', 'far fa-face-grin', 'fas fa-face-grin',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-beam', 'fal fa-face-grin-beam', 'far fa-face-grin-beam', 'fas fa-face-grin-beam',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-beam-sweat', 'fal fa-face-grin-beam-sweat', 'far fa-face-grin-beam-sweat', 'fas fa-face-grin-beam-sweat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-hearts', 'fal fa-face-grin-hearts', 'far fa-face-grin-hearts', 'fas fa-face-grin-hearts',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-squint', 'fal fa-face-grin-squint', 'far fa-face-grin-squint', 'fas fa-face-grin-squint',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-squint-tears', 'fal fa-face-grin-squint-tears', 'far fa-face-grin-squint-tears', 'fas fa-face-grin-squint-tears',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-stars', 'fal fa-face-grin-stars', 'far fa-face-grin-stars', 'fas fa-face-grin-stars',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-tears', 'fal fa-face-grin-tears', 'far fa-face-grin-tears', 'fas fa-face-grin-tears',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-tongue', 'fal fa-face-grin-tongue', 'far fa-face-grin-tongue', 'fas fa-face-grin-tongue',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-tongue-squint', 'fal fa-face-grin-tongue-squint', 'far fa-face-grin-tongue-squint', 'fas fa-face-grin-tongue-squint',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-tongue-wink', 'fal fa-face-grin-tongue-wink', 'far fa-face-grin-tongue-wink', 'fas fa-face-grin-tongue-wink',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-wide', 'fal fa-face-grin-wide', 'far fa-face-grin-wide', 'fas fa-face-grin-wide',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-grin-wink', 'fal fa-face-grin-wink', 'far fa-face-grin-wink', 'fas fa-face-grin-wink',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-hand-over-mouth', 'fal fa-face-hand-over-mouth', 'far fa-face-hand-over-mouth', 'fas fa-face-hand-over-mouth',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-hand-yawn', 'fal fa-face-hand-yawn', 'far fa-face-hand-yawn', 'fas fa-face-hand-yawn',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-hushed', 'fal fa-face-hushed', 'far fa-face-hushed', 'fas fa-face-hushed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-icicles', 'fal fa-face-icicles', 'far fa-face-icicles', 'fas fa-face-icicles',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-kiss', 'fal fa-face-kiss', 'far fa-face-kiss', 'fas fa-face-kiss',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-kiss-beam', 'fal fa-face-kiss-beam', 'far fa-face-kiss-beam', 'fas fa-face-kiss-beam',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-kiss-closed-eyes', 'fal fa-face-kiss-closed-eyes', 'far fa-face-kiss-closed-eyes', 'fas fa-face-kiss-closed-eyes',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-kiss-wink-heart', 'fal fa-face-kiss-wink-heart', 'far fa-face-kiss-wink-heart', 'fas fa-face-kiss-wink-heart',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-laugh', 'fal fa-face-laugh', 'far fa-face-laugh', 'fas fa-face-laugh',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-laugh-beam', 'fal fa-face-laugh-beam', 'far fa-face-laugh-beam', 'fas fa-face-laugh-beam',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-laugh-squint', 'fal fa-face-laugh-squint', 'far fa-face-laugh-squint', 'fas fa-face-laugh-squint',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-laugh-wink', 'fal fa-face-laugh-wink', 'far fa-face-laugh-wink', 'fas fa-face-laugh-wink',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-lying', 'fal fa-face-lying', 'far fa-face-lying', 'fas fa-face-lying',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-meh-blank', 'fal fa-face-meh-blank', 'far fa-face-meh-blank', 'fas fa-face-meh-blank',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-monocle', 'fal fa-face-monocle', 'far fa-face-monocle', 'fas fa-face-monocle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-nauseated', 'fal fa-face-nauseated', 'far fa-face-nauseated', 'fas fa-face-nauseated',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-nose-steam', 'fal fa-face-nose-steam', 'far fa-face-nose-steam', 'fas fa-face-nose-steam',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-party', 'fal fa-face-party', 'far fa-face-party', 'fas fa-face-party',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-pensive', 'fal fa-face-pensive', 'far fa-face-pensive', 'fas fa-face-pensive',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-persevering', 'fal fa-face-persevering', 'far fa-face-persevering', 'fas fa-face-persevering',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-pleading', 'fal fa-face-pleading', 'far fa-face-pleading', 'fas fa-face-pleading',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-pouting', 'fal fa-face-pouting', 'far fa-face-pouting', 'fas fa-face-pouting',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-raised-eyebrow', 'fal fa-face-raised-eyebrow', 'far fa-face-raised-eyebrow', 'fas fa-face-raised-eyebrow',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-relieved', 'fal fa-face-relieved', 'far fa-face-relieved', 'fas fa-face-relieved',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-rolling-eyes', 'fal fa-face-rolling-eyes', 'far fa-face-rolling-eyes', 'fas fa-face-rolling-eyes',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-sad-cry', 'fal fa-face-sad-cry', 'far fa-face-sad-cry', 'fas fa-face-sad-cry',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-sad-sweat', 'fal fa-face-sad-sweat', 'far fa-face-sad-sweat', 'fas fa-face-sad-sweat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-sad-tear', 'fal fa-face-sad-tear', 'far fa-face-sad-tear', 'fas fa-face-sad-tear',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-scream', 'fal fa-face-scream', 'far fa-face-scream', 'fas fa-face-scream',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-shush', 'fal fa-face-shush', 'far fa-face-shush', 'fas fa-face-shush',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-sleeping', 'fal fa-face-sleeping', 'far fa-face-sleeping', 'fas fa-face-sleeping',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-sleepy', 'fal fa-face-sleepy', 'far fa-face-sleepy', 'fas fa-face-sleepy',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-beam', 'fal fa-face-smile-beam', 'far fa-face-smile-beam', 'fas fa-face-smile-beam',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-halo', 'fal fa-face-smile-halo', 'far fa-face-smile-halo', 'fas fa-face-smile-halo',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-hearts', 'fal fa-face-smile-hearts', 'far fa-face-smile-hearts', 'fas fa-face-smile-hearts',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-horns', 'fal fa-face-smile-horns', 'far fa-face-smile-horns', 'fas fa-face-smile-horns',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-relaxed', 'fal fa-face-smile-relaxed', 'far fa-face-smile-relaxed', 'fas fa-face-smile-relaxed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-tear', 'fal fa-face-smile-tear', 'far fa-face-smile-tear', 'fas fa-face-smile-tear',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-tongue', 'fal fa-face-smile-tongue', 'far fa-face-smile-tongue', 'fas fa-face-smile-tongue',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-upside-down', 'fal fa-face-smile-upside-down', 'far fa-face-smile-upside-down', 'fas fa-face-smile-upside-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smile-wink', 'fal fa-face-smile-wink', 'far fa-face-smile-wink', 'fas fa-face-smile-wink',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smiling-hands', 'fal fa-face-smiling-hands', 'far fa-face-smiling-hands', 'fas fa-face-smiling-hands',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-smirking', 'fal fa-face-smirking', 'far fa-face-smirking', 'fas fa-face-smirking',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-sunglasses', 'fal fa-face-sunglasses', 'far fa-face-sunglasses', 'fas fa-face-sunglasses',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-surprise', 'fal fa-face-surprise', 'far fa-face-surprise', 'fas fa-face-surprise',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-swear', 'fal fa-face-swear', 'far fa-face-swear', 'fas fa-face-swear',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-thinking', 'fal fa-face-thinking', 'far fa-face-thinking', 'fas fa-face-thinking',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-tired', 'fal fa-face-tired', 'far fa-face-tired', 'fas fa-face-tired',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-tissue', 'fal fa-face-tissue', 'far fa-face-tissue', 'fas fa-face-tissue',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-tongue-money', 'fal fa-face-tongue-money', 'far fa-face-tongue-money', 'fas fa-face-tongue-money',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-tongue-sweat', 'fal fa-face-tongue-sweat', 'far fa-face-tongue-sweat', 'fas fa-face-tongue-sweat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-unamused', 'fal fa-face-unamused', 'far fa-face-unamused', 'fas fa-face-unamused',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-weary', 'fal fa-face-weary', 'far fa-face-weary', 'fas fa-face-weary',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-woozy', 'fal fa-face-woozy', 'far fa-face-woozy', 'fas fa-face-woozy',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-worried', 'fal fa-face-worried', 'far fa-face-worried', 'fas fa-face-worried',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-zany', 'fal fa-face-zany', 'far fa-face-zany', 'fas fa-face-zany',
					],
				...
				},
				{
					...
					options: [
						'fat fa-face-zipper', 'fal fa-face-zipper', 'far fa-face-zipper', 'fas fa-face-zipper',
					],
		...
		{
			id: 'energy',
			name: Loc.getMessage('LANDING_ICONS_SECTION_ENERGY'),
			items: [
				{
					className: 'far fa-atom',
					options: [
				...
				},
				{
					...
					options: [
						'fat fa-battery-bolt', 'fal fa-battery-bolt', 'far fa-battery-bolt', 'fas fa-battery-bolt',
					],
				...
				},
				{
					...
					options: [
						'fat fa-battery-empty', 'fal fa-battery-empty', 'far fa-battery-empty', 'fas fa-battery-empty',
					],
				...
				},
				{
					...
					options: [
						'fat fa-battery-full', 'fal fa-battery-full', 'far fa-battery-full', 'fas fa-battery-full',
					],
				...
				},
				{
					...
					options: [
						'fat fa-battery-half', 'fal fa-battery-half', 'far fa-battery-half', 'fas fa-battery-half',
					],
				...
				},
				{
					...
					options: [
						'fat fa-battery-low', 'fal fa-battery-low', 'far fa-battery-low', 'fas fa-battery-low',
					],
				...
				},
				{
					...
					options: [
						'fat fa-battery-quarter', 'fal fa-battery-quarter', 'far fa-battery-quarter', 'fas fa-battery-quarter',
					],
				...
				},
				{
					...
					options: [
						'fat fa-battery-slash', 'fal fa-battery-slash', 'far fa-battery-slash', 'fas fa-battery-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-battery-three-quarters', 'fal fa-battery-three-quarters', 'far fa-battery-three-quarters', 'fas fa-battery-three-quarters',
					],
				...
				},
				{
					...
					options: [
						'fat fa-burrito', 'fal fa-burrito', 'far fa-burrito', 'fas fa-burrito',
					],
				...
				},
				{
					...
					options: [
						'fat fa-lamp-street', 'fal fa-lamp-street', 'far fa-lamp-street', 'fas fa-lamp-street',
					],
				...
				},
				{
					...
					options: [
						'fat fa-manhole', 'fal fa-manhole', 'far fa-manhole', 'fas fa-manhole',
					],
				...
				},
				{
					...
					options: [
						'fat fa-meter-bolt', 'fal fa-meter-bolt', 'far fa-meter-bolt', 'fas fa-meter-bolt',
					],
				...
				},
				{
					...
					options: [
						'fat fa-meter-droplet', 'fal fa-meter-droplet', 'far fa-meter-droplet', 'fas fa-meter-droplet',
					],
				...
				},
				{
					...
					options: [
						'fat fa-meter-fire', 'fal fa-meter-fire', 'far fa-meter-fire', 'fas fa-meter-fire',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pedestal', 'fal fa-pedestal', 'far fa-pedestal', 'fas fa-pedestal',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pipe-circle-check', 'fal fa-pipe-circle-check', 'far fa-pipe-circle-check', 'fas fa-pipe-circle-check',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pipe-collar', 'fal fa-pipe-collar', 'far fa-pipe-collar', 'fas fa-pipe-collar',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pipe-section', 'fal fa-pipe-section', 'far fa-pipe-section', 'fas fa-pipe-section',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pipe-valve', 'fal fa-pipe-valve', 'far fa-pipe-valve', 'fas fa-pipe-valve',
					],
				...
				},
				{
					...
					options: [
						'fat fa-solar-panel', 'fal fa-solar-panel', 'far fa-solar-panel', 'fas fa-solar-panel',
					],
				...
				},
				{
					...
					options: [
						'fat fa-transformer-bolt', 'fal fa-transformer-bolt', 'far fa-transformer-bolt', 'fas fa-transformer-bolt',
					],
				...
				},
				{
					...
					options: [
						'fat fa-utility-pole', 'fal fa-utility-pole', 'far fa-utility-pole', 'fas fa-utility-pole',
					],
				...
				},
				{
					...
					options: [
						'fat fa-utility-pole-double', 'fal fa-utility-pole-double', 'far fa-utility-pole-double', 'fas fa-utility-pole-double',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wind-turbine', 'fal fa-wind-turbine', 'far fa-wind-turbine', 'fas fa-wind-turbine',
					],
		...
		{
			id: 'files',
			name: Loc.getMessage('LANDING_ICONS_SECTION_FILES'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-file-arrow-down', 'fal fa-file-arrow-down', 'far fa-file-arrow-down', 'fas fa-file-arrow-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-arrow-up', 'fal fa-file-arrow-up', 'far fa-file-arrow-up', 'fas fa-file-arrow-up',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-binary', 'fal fa-file-binary', 'far fa-file-binary', 'fas fa-file-binary',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-check', 'fal fa-file-check', 'far fa-file-check', 'fas fa-file-check',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-csv', 'fal fa-file-csv', 'far fa-file-csv', 'fas fa-file-csv',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-excel', 'fal fa-file-excel', 'far fa-file-excel', 'fas fa-file-excel',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-export', 'fal fa-file-export', 'far fa-file-export', 'fas fa-file-export',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-heart', 'fal fa-file-heart', 'far fa-file-heart', 'fas fa-file-heart',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-import', 'fal fa-file-import', 'far fa-file-import', 'fas fa-file-import',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-magnifying-glass', 'fal fa-file-magnifying-glass', 'far fa-file-magnifying-glass', 'fas fa-file-magnifying-glass',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-minus', 'fal fa-file-minus', 'far fa-file-minus', 'fas fa-file-minus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-pdf', 'fal fa-file-pdf', 'far fa-file-pdf', 'fas fa-file-pdf',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-pen', 'fal fa-file-pen', 'far fa-file-pen', 'fas fa-file-pen',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-plus', 'fal fa-file-plus', 'far fa-file-plus', 'fas fa-file-plus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-plus-minus', 'fal fa-file-plus-minus', 'far fa-file-plus-minus', 'fas fa-file-plus-minus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-powerpoint', 'fal fa-file-powerpoint', 'far fa-file-powerpoint', 'fas fa-file-powerpoint',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-slash', 'fal fa-file-slash', 'far fa-file-slash', 'fas fa-file-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-video', 'fal fa-file-video', 'far fa-file-video', 'fas fa-file-video',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-word', 'fal fa-file-word', 'far fa-file-word', 'fas fa-file-word',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-xmark', 'fal fa-file-xmark', 'far fa-file-xmark', 'fas fa-file-xmark',
					],
				...
				},
				{
					...
					options: [
						'fat fa-file-zipper', 'fal fa-file-zipper', 'far fa-file-zipper', 'fas fa-file-zipper',
					],
				...
				},
				{
					...
					options: [
						'fat fa-files', 'fal fa-files', 'far fa-files', 'fas fa-files',
					],
				...
				},
				{
					...
					options: [
						'fat fa-folder-blank', 'fal fa-folder-blank', 'far fa-folder-blank', 'fas fa-folder-blank',
					],
				...
				},
				{
					...
					options: [
						'fat fa-folder-bookmark', 'fal fa-folder-bookmark', 'far fa-folder-bookmark', 'fas fa-folder-bookmark',
					],
				...
				},
				{
					...
					options: [
						'fat fa-folder-gear', 'fal fa-folder-gear', 'far fa-folder-gear', 'fas fa-folder-gear',
					],
				...
				},
				{
					...
					options: [
						'fat fa-folder-grid', 'fal fa-folder-grid', 'far fa-folder-grid', 'fas fa-folder-grid',
					],
				...
				},
				{
					...
					options: [
						'fat fa-folder-heart', 'fal fa-folder-heart', 'far fa-folder-heart', 'fas fa-folder-heart',
					],
				...
				},
				{
					...
					options: [
						'fat fa-folder-magnifying-glass', 'fal fa-folder-magnifying-glass', 'far fa-folder-magnifying-glass', 'fas fa-folder-magnifying-glass',
					],
				...
				},
				{
					...
					options: [
						'fat fa-page', 'fal fa-page', 'far fa-page', 'fas fa-page',
					],
				...
				},
				{
					...
					options: [
						'fat fa-page-caret-down', 'fal fa-page-caret-down', 'far fa-page-caret-down', 'fas fa-page-caret-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-page-caret-up', 'fal fa-page-caret-up', 'far fa-page-caret-up', 'fas fa-page-caret-up',
					],
		...
		{
			id: 'film-video',
			name: Loc.getMessage('LANDING_ICONS_SECTION_FILM_VIDEO'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-camcorder', 'fal fa-camcorder', 'far fa-camcorder', 'fas fa-camcorder',
					],
				...
				},
				{
					...
					options: [
						'fat fa-camera-movie', 'fal fa-camera-movie', 'far fa-camera-movie', 'fas fa-camera-movie',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cassette-betamax', 'fal fa-cassette-betamax', 'far fa-cassette-betamax', 'fas fa-cassette-betamax',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cassette-vhs', 'fal fa-cassette-vhs', 'far fa-cassette-vhs', 'fas fa-cassette-vhs',
					],
				...
				},
				{
					...
					options: [
						'fat fa-circle-video', 'fal fa-circle-video', 'far fa-circle-video', 'fas fa-circle-video',
					],
				...
				},
				{
					...
					options: [
						'fat fa-circle-waveform-lines', 'fal fa-circle-waveform-lines', 'far fa-circle-waveform-lines', 'fas fa-circle-waveform-lines',
					],
				...
				},
				{
					...
					options: [
						'fat fa-clapperboard', 'fal fa-clapperboard', 'far fa-clapperboard', 'fas fa-clapperboard',
					],
				...
				},
				{
					...
					options: [
						'fat fa-clapperboard-play', 'fal fa-clapperboard-play', 'far fa-clapperboard-play', 'fas fa-clapperboard-play',
					],
				...
				},
				{
					...
					options: [
						'fat fa-podcast', 'fal fa-podcast', 'far fa-podcast', 'fas fa-podcast',
					],
				...
				},
				{
					...
					options: [
						'fat fa-video-arrow-down-left', 'fal fa-video-arrow-down-left', 'far fa-video-arrow-down-left', 'fas fa-video-arrow-down-left',
					],
				...
				},
				{
					...
					options: [
						'fat fa-video-arrow-up-right', 'fal fa-video-arrow-up-right', 'far fa-video-arrow-up-right', 'fas fa-video-arrow-up-right',
					],
		...
		{
			id: 'food-beverage',
			name: Loc.getMessage('LANDING_ICONS_SECTION_FOOD_BEVERAGE'),
			items: [
				{
					className: 'far fa-apple-whole',
					options: [
				...
				},
				{
					...
					options: [
						'fat fa-bacon', 'fal fa-bacon', 'far fa-bacon', 'fas fa-bacon',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bagel', 'fal fa-bagel', 'far fa-bagel', 'fas fa-bagel',
					],
				...
				},
				{
					...
					options: [
						'fat fa-baguette', 'fal fa-baguette', 'far fa-baguette', 'fas fa-baguette',
					],
				...
				},
				{
					...
					options: [
						'fat fa-beer-mug', 'fal fa-beer-mug', 'far fa-beer-mug', 'fas fa-beer-mug',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bowl-chopsticks', 'fal fa-bowl-chopsticks', 'far fa-bowl-chopsticks', 'fas fa-bowl-chopsticks',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bowl-chopsticks-noodles', 'fal fa-bowl-chopsticks-noodles', 'far fa-bowl-chopsticks-noodles', 'fas fa-bowl-chopsticks-noodles',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bowl-hot', 'fal fa-bowl-hot', 'far fa-bowl-hot', 'fas fa-bowl-hot',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bowl-rice', 'fal fa-bowl-rice', 'far fa-bowl-rice', 'fas fa-bowl-rice',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bowl-scoop', 'fal fa-bowl-scoop', 'far fa-bowl-scoop', 'fas fa-bowl-scoop',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bowl-scoops', 'fal fa-bowl-scoops', 'far fa-bowl-scoops', 'fas fa-bowl-scoops',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bread-loaf', 'fal fa-bread-loaf', 'far fa-bread-loaf', 'fas fa-bread-loaf',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bread-slice', 'fal fa-bread-slice', 'far fa-bread-slice', 'fas fa-bread-slice',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bread-slice-butter', 'fal fa-bread-slice-butter', 'far fa-bread-slice-butter', 'fas fa-bread-slice-butter',
					],
				...
				},
				{
					...
					options: [
						'fat fa-burger', 'fal fa-burger', 'far fa-burger', 'fas fa-burger',
					],
				...
				},
				{
					...
					options: [
						'fat fa-burger-cheese', 'fal fa-burger-cheese', 'far fa-burger-cheese', 'fas fa-burger-cheese',
					],
				...
				},
				{
					...
					options: [
						'fat fa-burger-fries', 'fal fa-burger-fries', 'far fa-burger-fries', 'fas fa-burger-fries',
					],
				...
				},
				{
					...
					options: [
						'fat fa-burger-glass', 'fal fa-burger-glass', 'far fa-burger-glass', 'fas fa-burger-glass',
					],
				...
				},
				{
					...
					options: [
						'fat fa-burger-lettuce', 'fal fa-burger-lettuce', 'far fa-burger-lettuce', 'fas fa-burger-lettuce',
					],
				...
				},
				{
					...
					options: [
						'fat fa-burger-soda', 'fal fa-burger-soda', 'far fa-burger-soda', 'fas fa-burger-soda',
					],
				...
				},
				{
					...
					options: [
						'fat fa-butter', 'fal fa-butter', 'far fa-butter', 'fas fa-butter',
					],
				...
				},
				{
					...
					options: [
						'fat fa-can-food', 'fal fa-can-food', 'far fa-can-food', 'fas fa-can-food',
					],
				...
				},
				{
					...
					options: [
						'fat fa-candy-cane', 'fal fa-candy-cane', 'far fa-candy-cane', 'fas fa-candy-cane',
					],
				...
				},
				{
					...
					options: [
						'fat fa-candy-corn', 'fal fa-candy-corn', 'far fa-candy-corn', 'fas fa-candy-corn',
					],
				...
				},
				{
					...
					options: [
						'fat fa-carrot', 'fal fa-carrot', 'far fa-carrot', 'fas fa-carrot',
					],
				...
				},
				{
					...
					options: [
						'fat fa-champagne-glass', 'fal fa-champagne-glass', 'far fa-champagne-glass', 'fas fa-champagne-glass',
					],
				...
				},
				{
					...
					options: [
						'fat fa-champagne-glasses', 'fal fa-champagne-glasses', 'far fa-champagne-glasses', 'fas fa-champagne-glasses',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cheese', 'fal fa-cheese', 'far fa-cheese', 'fas fa-cheese',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cheese-swiss', 'fal fa-cheese-swiss', 'far fa-cheese-swiss', 'fas fa-cheese-swiss',
					],
				...
				},
				{
					...
					options: [
						'fat fa-coffee-bean', 'fal fa-coffee-bean', 'far fa-coffee-bean', 'fas fa-coffee-bean',
					],
				...
				},
				{
					...
					options: [
						'fat fa-coffee-beans', 'fal fa-coffee-beans', 'far fa-coffee-beans', 'fas fa-coffee-beans',
					],
				...
				},
				{
					...
					options: [
						'fat fa-corn', 'fal fa-corn', 'far fa-corn', 'fas fa-corn',
					],
				...
				},
				{
					...
					options: [
						'fat fa-crate-apple', 'fal fa-crate-apple', 'far fa-crate-apple', 'fas fa-crate-apple',
					],
				...
				},
				{
					...
					options: [
						'fat fa-croissant', 'fal fa-croissant', 'far fa-croissant', 'fas fa-croissant',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cup-straw', 'fal fa-cup-straw', 'far fa-cup-straw', 'fas fa-cup-straw',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cup-straw-swoosh', 'fal fa-cup-straw-swoosh', 'far fa-cup-straw-swoosh', 'fas fa-cup-straw-swoosh',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cup-togo', 'fal fa-cup-togo', 'far fa-cup-togo', 'fas fa-cup-togo',
					],
				...
				},
				{
					...
					options: [
						'fat fa-custard', 'fal fa-custard', 'far fa-custard', 'fas fa-custard',
					],
				...
				},
				{
					...
					options: [
						'fat fa-donut', 'fal fa-donut', 'far fa-donut', 'fas fa-donut',
					],
				...
				},
				{
					...
					options: [
						'fat fa-drumstick', 'fal fa-drumstick', 'far fa-drumstick', 'fas fa-drumstick',
					],
				...
				},
				{
					...
					options: [
						'fat fa-drumstick-bite', 'fal fa-drumstick-bite', 'far fa-drumstick-bite', 'fas fa-drumstick-bite',
					],
				...
				},
				{
					...
					options: [
						'fat fa-egg', 'fal fa-egg', 'far fa-egg', 'fas fa-egg',
					],
				...
				},
				{
					...
					options: [
						'fat fa-egg-fried', 'fal fa-egg-fried', 'far fa-egg-fried', 'fas fa-egg-fried',
					],
				...
				},
				{
					...
					options: [
						'fat fa-falafel', 'fal fa-falafel', 'far fa-falafel', 'fas fa-falafel',
					],
				...
				},
				{
					...
					options: [
						'fat fa-flatbread', 'fal fa-flatbread', 'far fa-flatbread', 'fas fa-flatbread',
					],
				...
				},
				{
					...
					options: [
						'fat fa-flatbread-stuffed', 'fal fa-flatbread-stuffed', 'far fa-flatbread-stuffed', 'fas fa-flatbread-stuffed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-fondue-pot', 'fal fa-fondue-pot', 'far fa-fondue-pot', 'fas fa-fondue-pot',
					],
				...
				},
				{
					...
					options: [
						'fat fa-french-fries', 'fal fa-french-fries', 'far fa-french-fries', 'fas fa-french-fries',
					],
				...
				},
				{
					...
					options: [
						'fat fa-gingerbread-man', 'fal fa-gingerbread-man', 'far fa-gingerbread-man', 'fas fa-gingerbread-man',
					],
				...
				},
				{
					...
					options: [
						'fat fa-glass', 'fal fa-glass', 'far fa-glass', 'fas fa-glass',
					],
				...
				},
				{
					...
					options: [
						'fat fa-glass-citrus', 'fal fa-glass-citrus', 'far fa-glass-citrus', 'fas fa-glass-citrus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-glass-empty', 'fal fa-glass-empty', 'far fa-glass-empty', 'fas fa-glass-empty',
					],
				...
				},
				{
					...
					options: [
						'fat fa-glass-half', 'fal fa-glass-half', 'far fa-glass-half', 'fas fa-glass-half',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hat-chef', 'fal fa-hat-chef', 'far fa-hat-chef', 'fas fa-hat-chef',
					],
				...
				},
				{
					...
					options: [
						'fat fa-honey-pot', 'fal fa-honey-pot', 'far fa-honey-pot', 'fas fa-honey-pot',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hotdog', 'fal fa-hotdog', 'far fa-hotdog', 'fas fa-hotdog',
					],
				...
				},
				{
					...
					options: [
						'fat fa-jug', 'fal fa-jug', 'far fa-jug', 'fas fa-jug',
					],
				...
				},
				{
					...
					options: [
						'fat fa-meat', 'fal fa-meat', 'far fa-meat', 'fas fa-meat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mug', 'fal fa-mug', 'far fa-mug', 'fas fa-mug',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mug-hot', 'fal fa-mug-hot', 'far fa-mug-hot', 'fas fa-mug-hot',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mug-marshmallows', 'fal fa-mug-marshmallows', 'far fa-mug-marshmallows', 'fas fa-mug-marshmallows',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mug-tea', 'fal fa-mug-tea', 'far fa-mug-tea', 'fas fa-mug-tea',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mug-tea-saucer', 'fal fa-mug-tea-saucer', 'far fa-mug-tea-saucer', 'fas fa-mug-tea-saucer',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pan-food', 'fal fa-pan-food', 'far fa-pan-food', 'fas fa-pan-food',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pancakes', 'fal fa-pancakes', 'far fa-pancakes', 'fas fa-pancakes',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pepper-hot', 'fal fa-pepper-hot', 'far fa-pepper-hot', 'fas fa-pepper-hot',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pie', 'fal fa-pie', 'far fa-pie', 'fas fa-pie',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pizza', 'fal fa-pizza', 'far fa-pizza', 'fas fa-pizza',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pizza-slice', 'fal fa-pizza-slice', 'far fa-pizza-slice', 'fas fa-pizza-slice',
					],
				...
				},
				{
					...
					options: [
						'fat fa-popcorn', 'fal fa-popcorn', 'far fa-popcorn', 'fas fa-popcorn',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pot-food', 'fal fa-pot-food', 'far fa-pot-food', 'fas fa-pot-food',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pumpkin', 'fal fa-pumpkin', 'far fa-pumpkin', 'fas fa-pumpkin',
					],
				...
				},
				{
					...
					options: [
						'fat fa-salad', 'fal fa-salad', 'far fa-salad', 'fas fa-salad',
					],
				...
				},
				{
					...
					options: [
						'fat fa-salt-shaker', 'fal fa-salt-shaker', 'far fa-salt-shaker', 'fas fa-salt-shaker',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sandwich', 'fal fa-sandwich', 'far fa-sandwich', 'fas fa-sandwich',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sausage', 'fal fa-sausage', 'far fa-sausage', 'fas fa-sausage',
					],
				...
				},
				{
					...
					options: [
						'fat fa-steak', 'fal fa-steak', 'far fa-steak', 'fas fa-steak',
					],
				...
				},
				{
					...
					options: [
						'fat fa-taco', 'fal fa-taco', 'far fa-taco', 'fas fa-taco',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tamale', 'fal fa-tamale', 'far fa-tamale', 'fas fa-tamale',
					],
				...
				},
				{
					...
					options: [
						'fat fa-turkey', 'fal fa-turkey', 'far fa-turkey', 'fas fa-turkey',
					],
				...
				},
				{
					...
					options: [
						'fat fa-waffle', 'fal fa-waffle', 'far fa-waffle', 'fas fa-waffle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wheat', 'fal fa-wheat', 'far fa-wheat', 'fas fa-wheat',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wheat-awn', 'fal fa-wheat-awn', 'far fa-wheat-awn', 'fas fa-wheat-awn',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wheat-awn-slash', 'fal fa-wheat-awn-slash', 'far fa-wheat-awn-slash', 'fas fa-wheat-awn-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wheat-slash', 'fal fa-wheat-slash', 'far fa-wheat-slash', 'fas fa-wheat-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-whiskey-glass', 'fal fa-whiskey-glass', 'far fa-whiskey-glass', 'fas fa-whiskey-glass',
					],
				...
				},
				{
					...
					options: [
						'fat fa-whiskey-glass-ice', 'fal fa-whiskey-glass-ice', 'far fa-whiskey-glass-ice', 'fas fa-whiskey-glass-ice',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wine-bottle', 'fal fa-wine-bottle', 'far fa-wine-bottle', 'fas fa-wine-bottle',
					],
		...
		},
		{
			...
			name: Loc.getMessage('LANDING_ICONS_SECTION_FRUITS_VEGETABLES'),
			items: [
				{
					className: 'far fa-apple-core',
					options: [
						'fat fa-apple-core', 'fal fa-apple-core', 'far fa-apple-core', 'fas fa-apple-core',
					],
				...
				},
				{
					...
					options: [
						'fat fa-avocado', 'fal fa-avocado', 'far fa-avocado', 'fas fa-avocado',
					],
				...
				},
				{
					...
					options: [
						'fat fa-banana', 'fal fa-banana', 'far fa-banana', 'fas fa-banana',
					],
				...
				},
				{
					...
					options: [
						'fat fa-blueberries', 'fal fa-blueberries', 'far fa-blueberries', 'fas fa-blueberries',
					],
				...
				},
				{
					...
					options: [
						'fat fa-broccoli', 'fal fa-broccoli', 'far fa-broccoli', 'fas fa-broccoli',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cherries', 'fal fa-cherries', 'far fa-cherries', 'fas fa-cherries',
					],
				...
				},
				{
					...
					options: [
						'fat fa-citrus', 'fal fa-citrus', 'far fa-citrus', 'fas fa-citrus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-citrus-slice', 'fal fa-citrus-slice', 'far fa-citrus-slice', 'fas fa-citrus-slice',
					],
				...
				},
				{
					...
					options: [
						'fat fa-coconut', 'fal fa-coconut', 'far fa-coconut', 'fas fa-coconut',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cucumber', 'fal fa-cucumber', 'far fa-cucumber', 'fas fa-cucumber',
					],
				...
				},
				{
					...
					options: [
						'fat fa-eggplant', 'fal fa-eggplant', 'far fa-eggplant', 'fas fa-eggplant',
					],
				...
				},
				{
					...
					options: [
						'fat fa-garlic', 'fal fa-garlic', 'far fa-garlic', 'fas fa-garlic',
					],
				...
				},
				{
					...
					options: [
						'fat fa-grapes', 'fal fa-grapes', 'far fa-grapes', 'fas fa-grapes',
					],
				...
				},
				{
					...
					options: [
						'fat fa-kiwi-fruit', 'fal fa-kiwi-fruit', 'far fa-kiwi-fruit', 'fas fa-kiwi-fruit',
					],
				...
				},
				{
					...
					options: [
						'fat fa-leafy-green', 'fal fa-leafy-green', 'far fa-leafy-green', 'fas fa-leafy-green',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mango', 'fal fa-mango', 'far fa-mango', 'fas fa-mango',
					],
				...
				},
				{
					...
					options: [
						'fat fa-melon', 'fal fa-melon', 'far fa-melon', 'fas fa-melon',
					],
				...
				},
				{
					...
					options: [
						'fat fa-melon-slice', 'fal fa-melon-slice', 'far fa-melon-slice', 'fas fa-melon-slice',
					],
				...
				},
				{
					...
					options: [
						'fat fa-olive', 'fal fa-olive', 'far fa-olive', 'fas fa-olive',
					],
				...
				},
				{
					...
					options: [
						'fat fa-olive-branch', 'fal fa-olive-branch', 'far fa-olive-branch', 'fas fa-olive-branch',
					],
				...
				},
				{
					...
					options: [
						'fat fa-onion', 'fal fa-onion', 'far fa-onion', 'fas fa-onion',
					],
				...
				},
				{
					...
					options: [
						'fat fa-peach', 'fal fa-peach', 'far fa-peach', 'fas fa-peach',
					],
				...
				},
				{
					...
					options: [
						'fat fa-peanut', 'fal fa-peanut', 'far fa-peanut', 'fas fa-peanut',
					],
				...
				},
				{
					...
					options: [
						'fat fa-peanuts', 'fal fa-peanuts', 'far fa-peanuts', 'fas fa-peanuts',
					],
				...
				},
				{
					...
					options: [
						'fat fa-peapod', 'fal fa-peapod', 'far fa-peapod', 'fas fa-peapod',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pear', 'fal fa-pear', 'far fa-pear', 'fas fa-pear',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pepper', 'fal fa-pepper', 'far fa-pepper', 'fas fa-pepper',
					],
				...
				},
				{
					...
					options: [
						'fat fa-potato', 'fal fa-potato', 'far fa-potato', 'fas fa-potato',
					],
				...
				},
				{
					...
					options: [
						'fat fa-strawberry', 'fal fa-strawberry', 'far fa-strawberry', 'fas fa-strawberry',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tomato', 'fal fa-tomato', 'far fa-tomato', 'fas fa-tomato',
					],
				...
				},
				{
					...
					options: [
						'fat fa-watermelon-slice', 'fal fa-watermelon-slice', 'far fa-watermelon-slice', 'fas fa-watermelon-slice',
					],
		...
		{
			id: 'gaming',
			name: Loc.getMessage('LANDING_ICONS_SECTION_GAMING'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-axe-battle', 'fal fa-axe-battle', 'far fa-axe-battle', 'fas fa-axe-battle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-book-skull', 'fal fa-book-skull', 'far fa-book-skull', 'fas fa-book-skull',
					],
				...
				},
				{
					...
					options: [
						'fat fa-bow-arrow', 'fal fa-bow-arrow', 'far fa-bow-arrow', 'fas fa-bow-arrow',
					],
				...
				},
				{
					...
					options: [
						'fat fa-card-club', 'fal fa-card-club', 'far fa-card-club', 'fas fa-card-club',
					],
				...
				},
				{
					...
					options: [
						'fat fa-card-diamond', 'fal fa-card-diamond', 'far fa-card-diamond', 'fas fa-card-diamond',
					],
				...
				},
				{
					...
					options: [
						'fat fa-card-heart', 'fal fa-card-heart', 'far fa-card-heart', 'fas fa-card-heart',
					],
				...
				},
				{
					...
					options: [
						'fat fa-card-spade', 'fal fa-card-spade', 'far fa-card-spade', 'fas fa-card-spade',
					],
				...
				},
				{
					...
					options: [
						'fat fa-cards', 'fal fa-cards', 'far fa-cards', 'fas fa-cards',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess', 'fal fa-chess', 'far fa-chess', 'fas fa-chess',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-bishop', 'fal fa-chess-bishop', 'far fa-chess-bishop', 'fas fa-chess-bishop',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-bishop-piece', 'fal fa-chess-bishop-piece', 'far fa-chess-bishop-piece', 'fas fa-chess-bishop-piece',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-board', 'fal fa-chess-board', 'far fa-chess-board', 'fas fa-chess-board',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-clock', 'fal fa-chess-clock', 'far fa-chess-clock', 'fas fa-chess-clock',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-clock-flip', 'fal fa-chess-clock-flip', 'far fa-chess-clock-flip', 'fas fa-chess-clock-flip',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-king', 'fal fa-chess-king', 'far fa-chess-king', 'fas fa-chess-king',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-king-piece', 'fal fa-chess-king-piece', 'far fa-chess-king-piece', 'fas fa-chess-king-piece',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-knight', 'fal fa-chess-knight', 'far fa-chess-knight', 'fas fa-chess-knight',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-knight-piece', 'fal fa-chess-knight-piece', 'far fa-chess-knight-piece', 'fas fa-chess-knight-piece',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-pawn', 'fal fa-chess-pawn', 'far fa-chess-pawn', 'fas fa-chess-pawn',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-pawn-piece', 'fal fa-chess-pawn-piece', 'far fa-chess-pawn-piece', 'fas fa-chess-pawn-piece',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-queen', 'fal fa-chess-queen', 'far fa-chess-queen', 'fas fa-chess-queen',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-queen-piece', 'fal fa-chess-queen-piece', 'far fa-chess-queen-piece', 'fas fa-chess-queen-piece',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-rook', 'fal fa-chess-rook', 'far fa-chess-rook', 'fas fa-chess-rook',
					],
				...
				},
				{
					...
					options: [
						'fat fa-chess-rook-piece', 'fal fa-chess-rook-piece', 'far fa-chess-rook-piece', 'fas fa-chess-rook-piece',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dagger', 'fal fa-dagger', 'far fa-dagger', 'fas fa-dagger',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-d10', 'fal fa-dice-d10', 'far fa-dice-d10', 'fas fa-dice-d10',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-d12', 'fal fa-dice-d12', 'far fa-dice-d12', 'fas fa-dice-d12',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-d20', 'fal fa-dice-d20', 'far fa-dice-d20', 'fas fa-dice-d20',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-d4', 'fal fa-dice-d4', 'far fa-dice-d4', 'fas fa-dice-d4',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-d6', 'fal fa-dice-d6', 'far fa-dice-d6', 'fas fa-dice-d6',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-d8', 'fal fa-dice-d8', 'far fa-dice-d8', 'fas fa-dice-d8',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-four', 'fal fa-dice-four', 'far fa-dice-four', 'fas fa-dice-four',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-one', 'fal fa-dice-one', 'far fa-dice-one', 'fas fa-dice-one',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-six', 'fal fa-dice-six', 'far fa-dice-six', 'fas fa-dice-six',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-three', 'fal fa-dice-three', 'far fa-dice-three', 'fas fa-dice-three',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dice-two', 'fal fa-dice-two', 'far fa-dice-two', 'fas fa-dice-two',
					],
				...
				},
				{
					...
					options: [
						'fat fa-dreidel', 'fal fa-dreidel', 'far fa-dreidel', 'fas fa-dreidel',
					],
				...
				},
				{
					...
					options: [
						'fat fa-eye-evil', 'fal fa-eye-evil', 'far fa-eye-evil', 'fas fa-eye-evil',
					],
				...
				},
				{
					...
					options: [
						'fat fa-fire-flame', 'fal fa-fire-flame', 'far fa-fire-flame', 'fas fa-fire-flame',
					],
				...
				},
				{
					...
					options: [
						'fat fa-game-board', 'fal fa-game-board', 'far fa-game-board', 'fas fa-game-board',
					],
				...
				},
				{
					...
					options: [
						'fat fa-game-board-simple', 'fal fa-game-board-simple', 'far fa-game-board-simple', 'fas fa-game-board-simple',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ghost', 'fal fa-ghost', 'far fa-ghost', 'fas fa-ghost',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hammer-war', 'fal fa-hammer-war', 'far fa-hammer-war', 'fas fa-hammer-war',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-holding-magic', 'fal fa-hand-holding-magic', 'far fa-hand-holding-magic', 'fas fa-hand-holding-magic',
					],
				...
				},
				{
					...
					options: [
						'fat fa-headset', 'fal fa-headset', 'far fa-headset', 'fas fa-headset',
					],
				...
				},
				{
					...
					options: [
						'fat fa-helmet-battle', 'fal fa-helmet-battle', 'far fa-helmet-battle', 'fas fa-helmet-battle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-joystick', 'fal fa-joystick', 'far fa-joystick', 'fas fa-joystick',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mace', 'fal fa-mace', 'far fa-mace', 'fas fa-mace',
					],
				...
				},
				{
					...
					options: [
						'fat fa-nesting-dolls', 'fal fa-nesting-dolls', 'far fa-nesting-dolls', 'fas fa-nesting-dolls',
					],
				...
				},
				{
					...
					options: [
						'fat fa-pinball', 'fal fa-pinball', 'far fa-pinball', 'fas fa-pinball',
					],
				...
				},
				{
					...
					options: [
						'fat fa-puzzle-piece-simple', 'fal fa-puzzle-piece-simple', 'far fa-puzzle-piece-simple', 'fas fa-puzzle-piece-simple',
					],
				...
				},
				{
					...
					options: [
						'fat fa-scroll', 'fal fa-scroll', 'far fa-scroll', 'fas fa-scroll',
					],
				...
				},
				{
					...
					options: [
						'fat fa-scroll-old', 'fal fa-scroll-old', 'far fa-scroll-old', 'fas fa-scroll-old',
					],
				...
				},
				{
					...
					options: [
						'fat fa-scythe', 'fal fa-scythe', 'far fa-scythe', 'fas fa-scythe',
					],
				...
				},
				{
					...
					options: [
						'fat fa-shield-cross', 'fal fa-shield-cross', 'far fa-shield-cross', 'fas fa-shield-cross',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sickle', 'fal fa-sickle', 'far fa-sickle', 'fas fa-sickle',
					],
				...
				},
				{
					...
					options: [
						'fat fa-square-full', 'fal fa-square-full', 'far fa-square-full', 'fas fa-square-full',
					],
				...
				},
				{
					...
					options: [
						'fat fa-staff', 'fal fa-staff', 'far fa-staff', 'fas fa-staff',
					],
				...
				},
				{
					...
					options: [
						'fat fa-sword', 'fal fa-sword', 'far fa-sword', 'fas fa-sword',
					],
				...
				},
				{
					...
					options: [
						'fat fa-swords', 'fal fa-swords', 'far fa-swords', 'fas fa-swords',
					],
				...
				},
				{
					...
					options: [
						'fat fa-vr-cardboard', 'fal fa-vr-cardboard', 'far fa-vr-cardboard', 'fas fa-vr-cardboard',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wand', 'fal fa-wand', 'far fa-wand', 'fas fa-wand',
					],
				...
				},
				{
					...
					options: [
						'fat fa-wand-sparkles', 'fal fa-wand-sparkles', 'far fa-wand-sparkles', 'fas fa-wand-sparkles',
					],
		...
		{
			id: 'gender',
			name: Loc.getMessage('LANDING_ICONS_SECTION_GENDERS'),
			items: [
				{
					className: 'far fa-genderless',
					options: [
						'fat fa-genderless', 'fal fa-genderless', 'far fa-genderless', 'fas fa-genderless',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mars', 'fal fa-mars', 'far fa-mars', 'fas fa-mars',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mars-and-venus', 'fal fa-mars-and-venus', 'far fa-mars-and-venus', 'fas fa-mars-and-venus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mars-double', 'fal fa-mars-double', 'far fa-mars-double', 'fas fa-mars-double',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mars-stroke', 'fal fa-mars-stroke', 'far fa-mars-stroke', 'fas fa-mars-stroke',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mars-stroke-right', 'fal fa-mars-stroke-right', 'far fa-mars-stroke-right', 'fas fa-mars-stroke-right',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mars-stroke-up', 'fal fa-mars-stroke-up', 'far fa-mars-stroke-up', 'fas fa-mars-stroke-up',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mercury', 'fal fa-mercury', 'far fa-mercury', 'fas fa-mercury',
					],
				...
				},
				{
					...
					options: [
						'fat fa-neuter', 'fal fa-neuter', 'far fa-neuter', 'fas fa-neuter',
					],
				...
				},
				{
					...
					options: [
						'fat fa-transgender', 'fal fa-transgender', 'far fa-transgender', 'fas fa-transgender',
					],
				...
				},
				{
					...
					options: [
						'fat fa-venus', 'fal fa-venus', 'far fa-venus', 'fas fa-venus',
					],
				...
				},
				{
					...
					options: [
						'fat fa-venus-double', 'fal fa-venus-double', 'far fa-venus-double', 'fas fa-venus-double',
					],
				...
				},
				{
					...
					options: [
						'fat fa-venus-mars', 'fal fa-venus-mars', 'far fa-venus-mars', 'fas fa-venus-mars',
					],
		...
		{
			id: 'halloween',
			name: Loc.getMessage('LANDING_ICONS_SECTION_HALLOWEEN'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-broom', 'fal fa-broom', 'far fa-broom', 'fas fa-broom',
					],
				...
				},
				{
					...
					options: [
						'fat fa-candle-holder', 'fal fa-candle-holder', 'far fa-candle-holder', 'fas fa-candle-holder',
					],
				...
				},
				{
					...
					options: [
						'fat fa-claw-marks', 'fal fa-claw-marks', 'far fa-claw-marks', 'fas fa-claw-marks',
					],
				...
				},
				{
					...
					options: [
						'fat fa-coffin', 'fal fa-coffin', 'far fa-coffin', 'fas fa-coffin',
					],
				...
				},
				{
					...
					options: [
						'fat fa-jack-o-lantern', 'fal fa-jack-o-lantern', 'far fa-jack-o-lantern', 'fas fa-jack-o-lantern',
					],
				...
				},
				{
					...
					options: [
						'fat fa-knife-kitchen', 'fal fa-knife-kitchen', 'far fa-knife-kitchen', 'fas fa-knife-kitchen',
					],
				...
				},
				{
					...
					options: [
						'fat fa-scarecrow', 'fal fa-scarecrow', 'far fa-scarecrow', 'fas fa-scarecrow',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tombstone', 'fal fa-tombstone', 'far fa-tombstone', 'fas fa-tombstone',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tombstone-blank', 'fal fa-tombstone-blank', 'far fa-tombstone-blank', 'fas fa-tombstone-blank',
					],
		...
		{
			id: 'hands',
			name: Loc.getMessage('LANDING_ICONS_SECTION_HANDS'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-hand-back-fist', 'fal fa-hand-back-fist', 'far fa-hand-back-fist', 'fas fa-hand-back-fist',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-back-point-down', 'fal fa-hand-back-point-down', 'far fa-hand-back-point-down', 'fas fa-hand-back-point-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-back-point-left', 'fal fa-hand-back-point-left', 'far fa-hand-back-point-left', 'fas fa-hand-back-point-left',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-back-point-ribbon', 'fal fa-hand-back-point-ribbon', 'far fa-hand-back-point-ribbon', 'fas fa-hand-back-point-ribbon',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-back-point-right', 'fal fa-hand-back-point-right', 'far fa-hand-back-point-right', 'fas fa-hand-back-point-right',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-back-point-up', 'fal fa-hand-back-point-up', 'far fa-hand-back-point-up', 'fas fa-hand-back-point-up',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-fingers-crossed', 'fal fa-hand-fingers-crossed', 'far fa-hand-fingers-crossed', 'fas fa-hand-fingers-crossed',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-holding', 'fal fa-hand-holding', 'far fa-hand-holding', 'fas fa-hand-holding',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-holding-skull', 'fal fa-hand-holding-skull', 'far fa-hand-holding-skull', 'fas fa-hand-holding-skull',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-horns', 'fal fa-hand-horns', 'far fa-hand-horns', 'fas fa-hand-horns',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-lizard', 'fal fa-hand-lizard', 'far fa-hand-lizard', 'fas fa-hand-lizard',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-love', 'fal fa-hand-love', 'far fa-hand-love', 'fas fa-hand-love',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-middle-finger', 'fal fa-hand-middle-finger', 'far fa-hand-middle-finger', 'fas fa-hand-middle-finger',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-peace', 'fal fa-hand-peace', 'far fa-hand-peace', 'fas fa-hand-peace',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-point-down', 'fal fa-hand-point-down', 'far fa-hand-point-down', 'fas fa-hand-point-down',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-point-left', 'fal fa-hand-point-left', 'far fa-hand-point-left', 'fas fa-hand-point-left',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-point-ribbon', 'fal fa-hand-point-ribbon', 'far fa-hand-point-ribbon', 'fas fa-hand-point-ribbon',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-point-right', 'fal fa-hand-point-right', 'far fa-hand-point-right', 'fas fa-hand-point-right',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-point-up', 'fal fa-hand-point-up', 'far fa-hand-point-up', 'fas fa-hand-point-up',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-pointer', 'fal fa-hand-pointer', 'far fa-hand-pointer', 'fas fa-hand-pointer',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-scissors', 'fal fa-hand-scissors', 'far fa-hand-scissors', 'fas fa-hand-scissors',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-sparkles', 'fal fa-hand-sparkles', 'far fa-hand-sparkles', 'fas fa-hand-sparkles',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hand-wave', 'fal fa-hand-wave', 'far fa-hand-wave', 'fas fa-hand-wave',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hands-bubbles', 'fal fa-hands-bubbles', 'far fa-hands-bubbles', 'fas fa-hands-bubbles',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hands-clapping', 'fal fa-hands-clapping', 'far fa-hands-clapping', 'fas fa-hands-clapping',
					],
				...
				},
				{
					...
					options: [
						'fat fa-hands-holding', 'fal fa-hands-holding', 'far fa-hands-holding', 'fas fa-hands-holding',
					],
				...
				},
				{
					...
					options: [
						'fat fa-handshake-simple-slash', 'fal fa-handshake-simple-slash', 'far fa-handshake-simple-slash', 'fas fa-handshake-simple-slash',
					],
				...
				},
				{
					...
					options: [
						'fat fa-handshake-slash', 'fal fa-handshake-slash', 'far fa-handshake-slash', 'fas fa-handshake-slash',
					],
		...
		{
			id: 'holidays',
			name: Loc.getMessage('LANDING_ICONS_SECTION_HOLIDAYS'),
			items: [
				{
				...
				},
				{
					...
					options: [
						'fat fa-holly-berry', 'fal fa-holly-berry', 'far fa-holly-berry', 'fas fa-holly-berry',
					],
				...
				},
				{
					...
					options: [
						'fat fa-lights-holiday', 'fal fa-lights-holiday', 'far fa-lights-holiday', 'fas fa-lights-holiday',
					],
				...
				},
				{
					...
					options: [
						'fat fa-mistletoe', 'fal fa-mistletoe', 'far fa-mistletoe', 'fas fa-mistletoe',
					],
				...
				},
				{
					...
					options: [
						'fat fa-ornament', 'fal fa-ornament', 'far fa-ornament', 'fas fa-ornament',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tree-christmas', 'fal fa-tree-christmas', 'far fa-tree-christmas', 'fas fa-tree-christmas',
					],
				...
				},
				{
					...
					options: [
						'fat fa-tree-decorated', 'fal fa-tree-decorated', 'far fa-tree-decorated', 'fas fa-tree-decorated',
					],
