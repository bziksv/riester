this.BX=this.BX||{};this.BX.UI=this.BX.UI||{};(function(e,t,s,a,i,l,r,o,n,c,d,b){"use strict";let h=e=>e,v,p,u,m;var g=babelHelpers.classPrivateFieldLooseKey("parent");class P extends n.EventEmitter{constructor(){super();this.cache=new o.Cache.MemoryCache;Object.defineProperty(this,g,{writable:true,value:void 0});this.setEventNamespace("Main.Avatar.Editor")}getPriority(){return this.constructor.priority}setParentTab(e){babelHelpers.classPrivateFieldLooseBase(this,g)[g]=e}getHeaderContainer(){return this.cache.remember("headerContainer",(()=>{const e=this.constructor.code;const t=this.getHeader();if(t===null){return o.Tag.render(v||(v=h`<span style="display: none;" data-bx-role="tab-header"  data-bx-state="hidden" data-bx-name="${0}"></span>`),e)}return o.Tag.render(p||(p=h`<span class="ui-avatar-editor__tab-button-item" data-bx-role="tab-header" data-bx-state="visible" data-bx-name="${0}">${0}</span>`),e,t)}))}getHeader(){if(babelHelpers.classPrivateFieldLooseBase(this,g)[g]!==null)return this.constructor.code.toUpperCase();return null}getBodyContainer(){return this.cache.remember("bodyContainer",(()=>{const e=this.constructor.code;return o.Tag.render(u||(u=h`
			...
			<div>
				...
				</div>`));const t=e.querySelector('[data-bx-role="headers"]');const s=e.querySelector('[data-bx-role="bodies"]');Array.from(babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].entries()).forEach((([e,a])=>{o.Event.bind(a.getHeaderContainer(),"click",(()=>{this.setActiveTab(e)}));o.Dom.append(a.getHeaderContainer(),t);o.Dom.append(a.getBodyContainer(),s)}));if(t.querySelectorAll('[data-bx-state="visible"]').length>1){t.style.display="block"}[[C.code,e.querySelector('[data-bx-role="button-add-picture"][data-bx-id="upload-file"]'),()=>{babelHelpers.classPrivateFieldLooseBase(this,Et)[Et]()}],[H.code,e.querySelector('[data-bx-role="button-add-picture"][data-bx-id="snap-picture"]'),()=>{babelHelpers.classPrivateFieldLooseBase(this,Ot)[Ot]()}]].forEach((([e,t,s])=>{if(babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].has(e)){o.Event.bind(t,"click",s)}else{o.Dom.remove(t)}}));return e}))}setActiveTab(e,t=false){if(!babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].has(e)){return null}const s=this.cache.get("activeTabChangesCounter")||0;if(babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]!==e){if(babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]===null){babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]=e}else if(babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].has(babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt])){babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].get(babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]).inactivate()}if(babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]===C.code||babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]===H.code){babelHelpers.classPrivateFieldLooseBase(this,wt)[wt]=babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]}babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]=e;babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].get(babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt]).activate()}this.cache.set("activeTabChangesCounter",s+1);return babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].get(babelHelpers.classPrivateFieldLooseBase(this,Tt)[Tt])}getTab(e){return babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].get(e)}loadJSON(e){return this.loadData(JSON.parse(e))}loadData(e){return new Promise(((t,s)=>{if(o.Type.isPlainObject(e)&&e["src"]){babelHelpers.classPrivateFieldLooseBase(this,kt)[kt].load(e["src"]).then((()=>{if(e["maskId"]&&babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].has(fe.code)){babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].get(fe.code).maskById(e["maskId"]);babelHelpers.classPrivateFieldLooseBase(this,St)[St](fe.code)}else{babelHelpers.classPrivateFieldLooseBase(this,St)[St](we.code)}t(e["src"],this)})).catch(s)}else{babelHelpers.classPrivateFieldLooseBase(this,St)[St](C.code);t(null,this)}}))}loadSrc(e){return new Promise(((t,s)=>{babelHelpers.classPrivateFieldLooseBase(this,kt)[kt].load(e).then((()=>{this.setActiveTab(babelHelpers.classPrivateFieldLooseBase(this,xt)[xt].has(fe.code)?fe.code:we.code);t(e,this)})).catch((()=>{babelHelpers.classPrivateFieldLooseBase(this,Mt)[Mt]();s(e,this)}))}))}reset(){babelHelpers.classPrivateFieldLooseBase(this,kt)[kt].reset();babelHelpers.classPrivateFieldLooseBase(this,Mt)[Mt]();return this}packBlobAndMask(){return new Promise(((e,t)=>{babelHelpers.classPrivateFieldLooseBase(this,kt)[kt].getBlob().then((({blob:t})=>{var s;const a=Ke.getInstance();a[yt]=(s=a[yt])!=null?s:document.createElement("canvas");const i=a[yt];i.width=t.width;i.height=t.height;i.getContext("2d").drawImage(a.getCanvas(),0,0);if(!babelHelpers.classPrivateFieldLooseBase(this,It)[It]){return e({blob:t,canvas:i})}babelHelpers.classPrivateFieldLooseBase(this,It)[It].applyAndPack(i).then(((s,a)=>{e({blob:t,maskedBlob:s,maskId:a,canvas:i})})).catch((()=>{e({blob:t,canvas:i})}))})).catch((e=>t(e)))}))}packBlob(){return new Promise(((e,t)=>{babelHelpers.classPrivateFieldLooseBase(this,kt)[kt].getBlob().then(e).catch(t)}))}isEmpty(){return babelHelpers.classPrivateFieldLooseBase(this,kt)[kt].isEmpty()}isModified(){return babelHelpers.classPrivateFieldLooseBase(this,kt)[kt].imageFrame.changed}getCanvasEditor(){return babelHelpers.classPrivateFieldLooseBase(this,kt)[kt]}getCanvasZooming(){return babelHelpers.classPrivateFieldLooseBase(this,At)[At]}destroy(){}static createInstance(e,t){if(this.repo.has(e)){this.repo.get(e).destroy()}const s=new this(t);if(document.querySelector("#"+e)){s.ready((()=>{s.loadJSON(document.querySelector("#"+e).getAttribute("data-bx-ui-avatar-editor-info"))}))}if(o.Type.isStringFilled(e)){this.repo.set(e,s)}return s}static getInstanceById(e){if(this.repo.has(e)){return this.repo.get(e)}return null}static getOrCreateInstanceById(e,t){return this.getInstanceById(e)||this.createInstance(...arguments)}}function Dt(e){if(this.cache.get("activeTabChangesCounter")>0){return}this.setActiveTab(e);this.cache.delete("activeTabChangesCounter")}function jt(){this.setActiveTab(babelHelpers.classPrivateFieldLooseBase(this,wt)[wt])}function Nt(){this.setActiveTab(C.code);return this}function Kt(){this.setActiveTab(H.code);return this}Rt.justANumber=0;Rt.repo=new Map;var Ut=babelHelpers.classPrivateFieldLooseKey("getPopup");class $t extends Rt{constructor(...e){super(...e);Object.defineProperty(this,Ut,{value:zt})}hide(){babelHelpers.classPrivateFieldLooseBase(this,Ut)[Ut]().close()}show(e){this.ready((()=>{babelHelpers.classPrivateFieldLooseBase(this,Ut)[Ut]().show();if(o.Type.isStringFilled(e)){this.setActiveTab(e)}}))}showFile(e){this.ready((()=>{babelHelpers.classPrivateFieldLooseBase(this,Ut)[Ut]().show();if(e){return this.loadSrc(e)}}))}apply(){this.packBlobAndMask().then((({blob:e,maskedBlob:t,maskId:s,canvas:a})=>{if(e instanceof Blob){if(s>0){y.useRecently(s)}const i=new n.BaseEvent({compatData:[e,a],data:{blob:e,maskedBlob:t}});n.EventEmitter.emit(this,"onApply",i,{useGlobalNaming:true});this.emit("onApply",i)}})).catch((e=>{console.log("error: ",e)}))}onApply(e){this.subscribe("onApply",e);return this}subscribeOnFormIsReady(e,t){this.subscribe("onApply",(s=>{const a=new FormData;const{blob:i,maskedBlob:l}=s.getData();a.append(e+"[file]",i,i["name"]);if(l){a.append(e+"[maskedFile]",l,i["name"]);a.append(e+"[maskedFile][maskId]",l["maskId"])}t(new n.BaseEvent({data:{form:a,blob:i,maskedBlob:l,maskId:l?l["maskId"]:null}}))}))}click(){this.show()}get popup(){return babelHelpers.classPrivateFieldLooseBase(this,Ut)[Ut]()}static isCameraAvailable(){return H.isAvailable()}}function zt(){this.cache.remember("okButton",(()=>{const e=new d.SaveButton({onclick:()=>{if(e.getState()===d.ButtonState.ACTIVE){this.apply()}this.hide()}});if(this.isEmpty()){e.setState(d.ButtonState.DISABLED);this.subscribeOnce("onSet",(()=>{e.setState(d.ButtonState.ACTIVE)}))}return e}));return this.cache.remember("popup",(()=>c.PopupManager.create("popup_"+this.getId(),null,{className:"ui-avatar-editor__popup",autoHide:false,lightShadow:true,closeIcon:true,closeByEsc:true,titleBar:o.Loc.getMessage("JS_AVATAR_EDITOR_TITLE_BAR"),content:this.getContainer(),zIndex:BX.PopupWindowManager.getMaxZIndex()+1,overlay:{},contentColor:"white",contentNoPaddings:true,bindOnResize:false,draggable:true,isScrollBlock:true,buttons:[this.cache.remember("okButton"),new d.CancelButton({onclick:()=>{this.hide()}})],events:{onShow:()=>{this.emit("onOpen")},onClose:()=>{this.emit("onClose")}}})))}var qt=babelHelpers.classPrivateFieldLooseKey("id");var Vt=babelHelpers.classPrivateFieldLooseKey("showSlider");let Xt=$t;function Wt(){return Xt.createInstance(...arguments)}function Jt(){return Xt.isCameraAvailable()}function Gt(){return Xt.getInstanceById(...arguments)}function Yt(){return Xt.getOrCreateInstanceById(...arguments)}H.check();const Zt=o.Reflection.namespace("BX");Zt.AvatarEditor=Xt;e.Editor=Xt;e.MaskEditor=U;e.createInstance=Wt;e.getInstanceById=Gt;e.getOrCreateInstanceById=Yt;e.isCameraAvailable=Jt})(this.BX.UI.AvatarEditor=this.BX.UI.AvatarEditor||{},BX,BX,BX,BX.UI.EntitySelector,BX.UI.Dialogs,BX,BX,BX.Event,BX.Main,BX.UI,BX.UI.SidePanel);
