...
(function (exports,main_core,main_core_events) {
	...
	const PAGES_TO_PRELOAD = 3; // noinspection JSClosureCompilerSyntax
	...
	var _loadingDataPromise = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("loadingDataPromise");
	...
	class Document extends Item {
	  constructor(options) {
	    ...
	    Object.defineProperty(this, _loadingDataPromise, {
	      writable: true,
	      value: null
	    });
	  ...
	  loadData() {
	    if (babelHelpers.classPrivateFieldLooseBase(this, _loadingDataPromise)[_loadingDataPromise] !== null) {
	      return babelHelpers.classPrivateFieldLooseBase(this, _loadingDataPromise)[_loadingDataPromise];
	    }

	    const promise = new BXPromise();
	    babelHelpers.classPrivateFieldLooseBase(this, _loadingDataPromise)[_loadingDataPromise] = promise;

	    if (this._pdfSrc) {
	      this.loadLibrary().then(() => {
	        babelHelpers.classPrivateFieldLooseBase(this, _loadingDataPromise)[_loadingDataPromise] = null;
	...
	class PrintService {
	  ...
	  renderPage(pageNumber) {
	    return this.pdf.getPage(pageNumber).then(function (page) {
	      ...
	      const viewport = page.getViewport(1); // The size of the canvas in pixels for printing.

	      const PRINT_RESOLUTION = 150;
	      const PRINT_UNITS = PRINT_RESOLUTION / 72.0;
	      scratchCanvas.width = Math.floor(viewport.width * PRINT_UNITS);
	      scratchCanvas.height = Math.floor(viewport.height * PRINT_UNITS); // The physical size of the img as specified by the PDF document.
