...
$APPLICATION->SetPageProperty("title", "Каталог медицинского оборудования Riester купить от производителя - интернет магазин с доставкой по РФ");
$APPLICATION->SetPageProperty("keywords", "каталог Riester, оборудование");
$APPLICATION->SetPageProperty("description", "Каталог медицинского оборудования Riester купить, выгодные цены в интернет магазине +7(495)133-16-94 Звоните! Доставка по РФ");
$APPLICATION->SetTitle("Медицинская техника Riester -прямые поставки от производителя");
?><div class="wrapper">
